                    ...
                    <form action="{{ URL::to('admin/categories/save') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="mt-3 {{ session()->get('direction') == '2' ? 'text-start' : 'text-end' }}">
                                ...
                                <button class="btn btn-primary px-sm-4 {{Auth::user()->type == 4 ? (helper::check_access('role_categories', Auth::user()->role_id, $vendor_id, 'add') == 1  ? '':'d-none'): ''}}" @if (env('Environment') == 'sendbox') type="button"
