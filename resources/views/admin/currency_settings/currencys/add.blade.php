        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb m-0">
                <li class="breadcrumb-item text-dark"><a
                        href="{{ URL::to('admin/currencys') }}" class="color-changer">{{ trans('labels.currency') }}</a>
                </li>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="currency" id="currency"
                                    value="{{ old('name') }}" placeholder="{{ trans('labels.currency') }}" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="currency_symbol"
                                    value="{{ old('name') }}" placeholder="{{ trans('labels.currency_symbol') }}"
                                    required>
