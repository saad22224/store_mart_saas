...
@section('content')
    ...
    <form action="{{ url('admin/landing2/update') }}" method="POST">
        @csrf
        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input type="text" name="translations[meta][page_title][ar]" class="form-control" 
                                    value="{{ @$translations['meta']['page_title']['ar']['value'] ?? 'Matjar Hub - منصة التجارة الإلكترونية المتكاملة' }}">
                            </div>
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Page Title (English)</label>
                                <input type="text" name="translations[meta][page_title][en]" class="form-control" 
                                    value="{{ @$translations['meta']['page_title']['en']['value'] ?? 'Matjar Hub - Integrated E-Commerce Platform' }}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 mb-4">
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="row">
                            @foreach(['home', 'who_we_are', 'why_us', 'faq', 'contact', 'start_now'] as $field)
                            <div class="col-md-4 form-group mb-3">
                                <label class="fw-500 text-capitalize">{{ str_replace('_', ' ', $field) }} (AR)</label>
                                <input type="text" name="translations[nav][{{ $field }}][ar]" class="form-control" 
                                    value="{{ @$translations['nav'][$field]['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-4 form-group mb-3">
                                <label class="fw-500 text-capitalize">{{ str_replace('_', ' ', $field) }} (EN)</label>
                                <input type="text" name="translations[nav][{{ $field }}][en]" class="form-control" 
                                    value="{{ @$translations['nav'][$field]['en']['value'] ?? '' }}">
                            </div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row border-bottom pb-3 mb-3">
                            <div class="col-12 mb-2">
                                <strong class="text-secondary">Stat #{{ $i }}</strong>
                            </div>
                            <div class="col-md-3 form-group">
                                <label class="fw-500">Number</label>
                                <input type="text" name="translations[stats][stat{{ $i }}_number][ar]" class="form-control" 
                                    value="{{ @$translations['stats']['stat'.$i.'_number']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-3 form-group">
                                <label class="fw-500">Label (AR)</label>
                                <input type="text" name="translations[stats][stat{{ $i }}_label][ar]" class="form-control" 
                                    value="{{ @$translations['stats']['stat'.$i.'_label']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-3 form-group">
                                <label class="fw-500">Number (EN)</label>
                                <input type="text" name="translations[stats][stat{{ $i }}_number][en]" class="form-control" 
                                    value="{{ @$translations['stats']['stat'.$i.'_number']['en']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-3 form-group">
                                <label class="fw-500">Label (EN)</label>
                                <input type="text" name="translations[stats][stat{{ $i }}_label][en]" class="form-control" 
                                    value="{{ @$translations['stats']['stat'.$i.'_label']['en']['value'] ?? '' }}">
                            </div>
                        </div>
                        @endfor
                    </div>
            ...
            <div class="col-12 mb-4">
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input type="text" name="translations[who_we_are][tag][ar]" class="form-control" 
                                    value="{{ @$translations['who_we_are']['tag']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Tag (EN)</label>
                                <input type="text" name="translations[who_we_are][tag][en]" class="form-control" 
                                    value="{{ @$translations['who_we_are']['tag']['en']['value'] ?? '' }}">
                            </div>
                            
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Title Line 1 (AR)</label>
                                <input type="text" name="translations[who_we_are][title_line1][ar]" class="form-control" 
                                    value="{{ @$translations['who_we_are']['title_line1']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Title Line 1 (EN)</label>
                                <input type="text" name="translations[who_we_are][title_line1][en]" class="form-control" 
                                    value="{{ @$translations['who_we_are']['title_line1']['en']['value'] ?? '' }}">
                            </div>
                            
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Title Highlight (AR)</label>
                                <input type="text" name="translations[who_we_are][title_highlight][ar]" class="form-control" 
                                    value="{{ @$translations['who_we_are']['title_highlight']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Title Highlight (EN)</label>
                                <input type="text" name="translations[who_we_are][title_highlight][en]" class="form-control" 
                                    value="{{ @$translations['who_we_are']['title_highlight']['en']['value'] ?? '' }}">
                            </div>
                            
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Description 1 (AR)</label>
                                <textarea name="translations[who_we_are][description1][ar]" class="form-control" rows="3">{{ @$translations['who_we_are']['description1']['ar']['value'] ?? '' }}</textarea>
                            </div>
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Description 1 (EN)</label>
                                <textarea name="translations[who_we_are][description1][en]" class="form-control" rows="3">{{ @$translations['who_we_are']['description1']['en']['value'] ?? '' }}</textarea>
                            </div>
                            
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Description 2 (AR)</label>
                                <textarea name="translations[who_we_are][description2][ar]" class="form-control" rows="3">{{ @$translations['who_we_are']['description2']['ar']['value'] ?? '' }}</textarea>
                            </div>
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Description 2 (EN)</label>
                                <textarea name="translations[who_we_are][description2][en]" class="form-control" rows="3">{{ @$translations['who_we_are']['description2']['en']['value'] ?? '' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3 form-group">
                                <label class="fw-500">Stat {{ $i }} Number</label>
                                <input type="text" name="translations[who_we_are][stat{{ $i }}_number][ar]" class="form-control" 
                                    value="{{ @$translations['who_we_are']['stat'.$i.'_number']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-3 form-group">
                                <label class="fw-500">Stat {{ $i }} Label (AR)</label>
                                <input type="text" name="translations[who_we_are][stat{{ $i }}_label][ar]" class="form-control" 
                                    value="{{ @$translations['who_we_are']['stat'.$i.'_label']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-3 form-group">
                                <label class="fw-500">Stat {{ $i }} Number (EN)</label>
                                <input type="text" name="translations[who_we_are][stat{{ $i }}_number][en]" class="form-control" 
                                    value="{{ @$translations['who_we_are']['stat'.$i.'_number']['en']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-3 form-group">
                                <label class="fw-500">Stat {{ $i }} Label (EN)</label>
                                <input type="text" name="translations[who_we_are][stat{{ $i }}_label][en]" class="form-control" 
                                    value="{{ @$translations['who_we_are']['stat'.$i.'_label']['en']['value'] ?? '' }}">
                            </div>
                        </div>
                        @endfor
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input type="text" name="translations[who_we_are][float_badge_title][ar]" class="form-control" 
                                    value="{{ @$translations['who_we_are']['float_badge_title']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input type="text" name="translations[who_we_are][float_badge_title][en]" class="form-control" 
                                    value="{{ @$translations['who_we_are']['float_badge_title']['en']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input type="text" name="translations[who_we_are][float_badge_subtitle][ar]" class="form-control" 
                                    value="{{ @$translations['who_we_are']['float_badge_subtitle']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input type="text" name="translations[who_we_are][float_badge_subtitle][en]" class="form-control" 
                                    value="{{ @$translations['who_we_are']['float_badge_subtitle']['en']['value'] ?? '' }}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 mb-4">
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input type="text" name="translations[why_us][title][ar]" class="form-control" 
                                    value="{{ @$translations['why_us']['title']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Title (EN)</label>
                                <input type="text" name="translations[why_us][title][en]" class="form-control" 
                                    value="{{ @$translations['why_us']['title']['en']['value'] ?? '' }}">
                            </div>
                            
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Title Highlight (AR)</label>
                                <input type="text" name="translations[why_us][title_highlight][ar]" class="form-control" 
                                    value="{{ @$translations['why_us']['title_highlight']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Title Highlight (EN)</label>
                                <input type="text" name="translations[why_us][title_highlight][en]" class="form-control" 
                                    value="{{ @$translations['why_us']['title_highlight']['en']['value'] ?? '' }}">
                            </div>
                            
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Subtitle (AR)</label>
                                <textarea name="translations[why_us][subtitle][ar]" class="form-control" rows="2">{{ @$translations['why_us']['subtitle']['ar']['value'] ?? '' }}</textarea>
                            </div>
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Subtitle (EN)</label>
                                <textarea name="translations[why_us][subtitle][en]" class="form-control" rows="2">{{ @$translations['why_us']['subtitle']['en']['value'] ?? '' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row border-bottom pb-3 mb-3">
                            <div class="col-12 mb-2">
                                <strong class="text-secondary">Card #{{ $i }}</strong>
                            </div>
                            <div class="col-md-6 form-group mb-2">
                                <label class="fw-500">Title (AR)</label>
                                <input type="text" name="translations[why_us][card{{ $i }}_title][ar]" class="form-control" 
                                    value="{{ @$translations['why_us']['card'.$i.'_title']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-6 form-group mb-2">
                                <label class="fw-500">Title (EN)</label>
                                <input type="text" name="translations[why_us][card{{ $i }}_title][en]" class="form-control" 
                                    value="{{ @$translations['why_us']['card'.$i.'_title']['en']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-6 form-group">
                                <label class="fw-500">Description (AR)</label>
                                <textarea name="translations[why_us][card{{ $i }}_desc][ar]" class="form-control" rows="2">{{ @$translations['why_us']['card'.$i.'_desc']['ar']['value'] ?? '' }}</textarea>
                            </div>
                            <div class="col-md-6 form-group">
                                <label class="fw-500">Description (EN)</label>
                                <textarea name="translations[why_us][card{{ $i }}_desc][en]" class="form-control" rows="2">{{ @$translations['why_us']['card'.$i.'_desc']['en']['value'] ?? '' }}</textarea>
                            </div>
                        </div>
                        @endfor
                    </div>
            ...
            <div class="col-12 mb-4">
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 form-group">
                                <label class="fw-500">Check {{ $i }} (AR)</label>
                                <input type="text" name="translations[value][check{{ $i }}][ar]" class="form-control" 
                                    value="{{ @$translations['value']['check'.$i]['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-6 form-group">
                                <label class="fw-500">Check {{ $i }} (EN)</label>
                                <input type="text" name="translations[value][check{{ $i }}][en]" class="form-control" 
                                    value="{{ @$translations['value']['check'.$i]['en']['value'] ?? '' }}">
                            </div>
                        </div>
                        @endfor
                    </div>
            ...
            <div class="col-12 mb-4">
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row border-bottom pb-3 mb-3">
                            <div class="col-12 mb-2">
                                <strong class="text-secondary">FAQ #{{ $i }}</strong>
                            </div>
                            <div class="col-md-6 form-group mb-2">
                                <label class="fw-500">Question (AR)</label>
                                <input type="text" name="translations[faq][q{{ $i }}][ar]" class="form-control" 
                                    value="{{ @$translations['faq']['q'.$i]['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-6 form-group mb-2">
                                <label class="fw-500">Question (EN)</label>
                                <input type="text" name="translations[faq][q{{ $i }}][en]" class="form-control" 
                                    value="{{ @$translations['faq']['q'.$i]['en']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-6 form-group">
                                <label class="fw-500">Answer (AR)</label>
                                <textarea name="translations[faq][a{{ $i }}][ar]" class="form-control" rows="3">{{ @$translations['faq']['a'.$i]['ar']['value'] ?? '' }}</textarea>
                            </div>
                            <div class="col-md-6 form-group">
                                <label class="fw-500">Answer (EN)</label>
                                <textarea name="translations[faq][a{{ $i }}][en]" class="form-control" rows="3">{{ @$translations['faq']['a'.$i]['en']['value'] ?? '' }}</textarea>
                            </div>
                        </div>
                        @endfor
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input type="text" name="translations[contact][title_line1][ar]" class="form-control" 
                                    value="{{ @$translations['contact']['title_line1']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Title Line 1 (EN)</label>
                                <input type="text" name="translations[contact][title_line1][en]" class="form-control" 
                                    value="{{ @$translations['contact']['title_line1']['en']['value'] ?? '' }}">
                            </div>
                            
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Title Highlight (AR)</label>
                                <input type="text" name="translations[contact][title_highlight][ar]" class="form-control" 
                                    value="{{ @$translations['contact']['title_highlight']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Title Highlight (EN)</label>
                                <input type="text" name="translations[contact][title_highlight][en]" class="form-control" 
                                    value="{{ @$translations['contact']['title_highlight']['en']['value'] ?? '' }}">
                            </div>
                            
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Description (AR)</label>
                                <textarea name="translations[contact][description][ar]" class="form-control" rows="2">{{ @$translations['contact']['description']['ar']['value'] ?? '' }}</textarea>
                            </div>
                            <div class="col-md-6 form-group mb-3">
                                <label class="fw-500">Description (EN)</label>
                                <textarea name="translations[contact][description][en]" class="form-control" rows="2">{{ @$translations['contact']['description']['en']['value'] ?? '' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group mb-2">
                                ...
                                <input type="text" name="translations[contact][form_name_placeholder][ar]" class="form-control" 
                                    value="{{ @$translations['contact']['form_name_placeholder']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                ...
                                <input type="text" name="translations[contact][form_name_placeholder][en]" class="form-control" 
                                    value="{{ @$translations['contact']['form_name_placeholder']['en']['value'] ?? '' }}">
                            </div>
                            
                            <div class="col-md-3 form-group mb-2">
                                <label class="fw-500">Email Label (AR)</label>
                                <input type="text" name="translations[contact][form_email][ar]" class="form-control" 
                                    value="{{ @$translations['contact']['form_email']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                <label class="fw-500">Email Label (EN)</label>
                                <input type="text" name="translations[contact][form_email][en]" class="form-control" 
                                    value="{{ @$translations['contact']['form_email']['en']['value'] ?? '' }}">
                            </div>
                            ...
                            <div class="col-md-3 form-group mb-2">
                                ...
                                <input type="text" name="translations[contact][form_inquiry_type][ar]" class="form-control" 
                                    value="{{ @$translations['contact']['form_inquiry_type']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                ...
                                <input type="text" name="translations[contact][form_inquiry_type][en]" class="form-control" 
                                    value="{{ @$translations['contact']['form_inquiry_type']['en']['value'] ?? '' }}">
                            </div>
                            ...
                            <div class="col-md-3 form-group mb-2">
                                ...
                                <input type="text" name="translations[contact][form_inquiry_support][ar]" class="form-control" 
                                    value="{{ @$translations['contact']['form_inquiry_support']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                ...
                                <input type="text" name="translations[contact][form_inquiry_support][en]" class="form-control" 
                                    value="{{ @$translations['contact']['form_inquiry_support']['en']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                ...
                                <input type="text" name="translations[contact][form_inquiry_sales][ar]" class="form-control" 
                                    value="{{ @$translations['contact']['form_inquiry_sales']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                ...
                                <input type="text" name="translations[contact][form_inquiry_sales][en]" class="form-control" 
                                    value="{{ @$translations['contact']['form_inquiry_sales']['en']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                ...
                                <input type="text" name="translations[contact][form_inquiry_partners][ar]" class="form-control" 
                                    value="{{ @$translations['contact']['form_inquiry_partners']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                ...
                                <input type="text" name="translations[contact][form_inquiry_partners][en]" class="form-control" 
                                    value="{{ @$translations['contact']['form_inquiry_partners']['en']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                ...
                                <input type="text" name="translations[contact][form_inquiry_other][ar]" class="form-control" 
                                    value="{{ @$translations['contact']['form_inquiry_other']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-3 form-group mb-2">
                            ...
                            <div class="col-md-3 form-group mb-2">
                                ...
                                <input type="text" name="translations[contact][form_message_placeholder][ar]" class="form-control" 
                                    value="{{ @$translations['contact']['form_message_placeholder']['ar']['value'] ?? '' }}">
                            </div>
                            <div class="col-md-3 form-group mb-2">
