                ...
                <div class="ob-p on" id="p1">
                    ...
                    <div class="cat-grid" id="catGrid">
                        ...
                        @foreach ($defaultCats as $c)
                            <div class="cat-chip" onclick="toggleCat(this)" data-name="{{ $c['name'] }}"
                                data-img="{{ $c['img'] }}">
                ...
                <div class="ob-p" id="p3">
                    ...
                    <div class="row">
                        <div class="col-md-6 set-row">
                            ...
                            <input type="email" id="setEmail" value="{{ @$settings->email ?? '' }}"
                        ...
                        <div class="col-md-6 set-row">
                            ...
                            <div style="display: flex; gap: 0.5rem;">
                                ...
                                <input type="text" id="setMobile" value="{{ @$settings->mobile ?? '' }}"
                        ...
                        <div class="col-md-6 set-row">
                            ...
                            <div style="display: flex; gap: 0.5rem;">
                                ...
                                <input type="text" id="setWhatsapp" value="{{ @Auth::user()->whatsapp ?? '' }}"
                                    placeholder="0123456789" style="flex: 1;" dir="ltr">
                            </div>
                        </div>
                        <div class="col-md-6 set-row">
                            <label>العنوان *</label>
                            <input type="text" id="setAddress" value="{{ @$settings->address ?? '' }}"
