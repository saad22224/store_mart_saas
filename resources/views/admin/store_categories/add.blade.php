        ...
        <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item text-dark">
                    <a href="{{ URL::to('admin/store_categories') }}" class="color-changer">{{ trans('labels.store_categories') }}</a>
                </li>
                    ...
                    <form action="{{ URL::to('admin/store_categories/save') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="mt-3 {{ session()->get('direction') == '2' ? 'text-start' : 'text-end' }}">
                                ...
                                <button
                                    class="btn btn-primary px-sm-4 {{ Auth::user()->type == 4 ? (helper::check_access('role_store_categories', Auth::user()->role_id, Auth::user()->vendor_id, 'add') == 1 ? '' : 'd-none') : '' }}"
