...
<style>
    ...
    .t16-cat-reveal-wrap {
        ...
        align-items:center;
        z-index:10;
        {{ session()->get('direction') == 2 ? 'left:0;' : 'right:0;' }}
        background: {{ session()->get('direction') == 2 ? 'linear-gradient(90deg, #fff 40%, rgba(255,255,255,0) 100%)' : 'linear-gradient(270deg, #fff 40%, rgba(255,255,255,0) 100%)' }};
        padding: {{ session()->get('direction') == 2 ? '0 30px 0 10px' : '0 10px 0 30px' }};
    }
