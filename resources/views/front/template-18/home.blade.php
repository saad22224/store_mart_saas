    ...
    <section class="tpl18-hero-section" id="tpl18HeroSlider">
        <div class="tpl18-slides-wrap" id="tpl18SlidesWrap">
            ...
            @foreach ($sliderItems as $slider)
                ...
                <a href="{{ $sliderHref }}" class="tpl18-slide {{ $loop->first ? 'is-active' : '' }}"
                    @if ($sliderOnClick) onclick="{{ $sliderOnClick }}" @endif
                    data-index="{{ $loop->index }}">
                    <img class="tpl18-slide-img" src="{{ $imgSrc }}" alt="{{ $storeinfo->name }}">
                </a>
            @endforeach
        </div>
                        ...
                        <div class="tpl17-category-carousel">
                            ...
                            <div class="tpl17-category-track" id="tpl17CategoryTrack">
                                @foreach ($categories as $category)
                                    <a href="{{ URL::to(@$storeinfo->slug . '/category/' . $category->slug) }}"
                        ...
                        <div class="row g-4">
                            <div class="col-lg-3 col-md-12">
                                <div
                                    ...
                                    <img src="{{ @helper::image_path($best_sellers[0]->image) }}"
                                    ...
                                    <div
                                        ...
                                        <h3 class="text-white fw-bold"
                                            ...
                                            {{ @$best_sellers[0]->category_info->name ?? trans('labels.category') }}
                                        </h3>
                                        <a href="{{ URL::to(@$storeinfo->slug . '/category/' . @$best_sellers[0]->category_info->slug) }}"
                                            class="btn"
                                            style="background: #000; color: #fff; border-radius: 30px; padding: 10px 35px; font-weight: 600; font-size: 15px; border: none; box-shadow: 0 4px 10px rgba(0,0,0,0.2);">{{ trans('labels.view_all') ?? 'View All' }}</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-4">
                                    @foreach ($best_sellers as $product)
                                        <div class="col-lg-4 col-md-6 col-6" data-aos="fade-up"
                                            ...
                                            @include('front.template-18.partials.product_card', [
                                                'product' => $product,
                                            ])
                                        </div>
                                    @endforeach
                    ...
                    <div class="container">
                        ...
                        <div class="row g-4">
                            <div class="col-lg-3 col-md-12">
                                <div
                                    style="border-radius: 20px; overflow: hidden; height: 100%; min-height: 400px; position: relative; padding: 20px; background: #f4f4f4;">
                                    <img src="{{ @helper::image_path($featured_products[0]->image) }}"
                                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; z-index: 1;">
                                    <div
                                        style="position: absolute; top:0; left:0; width:100%; height:100%; background: rgba(0,0,0,0.15); z-index: 2;">
                                    </div>
                                    <div
                                        ...
                                        <h3 class="text-white fw-bold"
                                            style="font-size: 38px; margin-bottom: 20px; text-shadow: 0 2px 4px rgba(0,0,0,0.2);">
                                            {{ @$featured_products[0]->category_info->name ?? trans('labels.category') }}
                                        </h3>
                                        <a href="{{ URL::to(@$storeinfo->slug . '/category/' . @$featured_products[0]->category_info->slug) }}"
                                            class="btn"
                                            style="background: #000; color: #fff; border-radius: 30px; padding: 10px 35px; font-weight: 600; font-size: 15px; border: none; box-shadow: 0 4px 10px rgba(0,0,0,0.2);">{{ trans('labels.view_all') ?? 'View All' }}</a>
                                    </div>
                                </div>
                            ...
                            @foreach ($exclusive_offers as $product)
                                <div class="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration="800"
                                    ...
                                    <a href="{{ URL::to(@$storeinfo->slug . '/detail-' . $product->slug) }}"
                                        ...
                                        <img src="{{ helper::image_path($product->image) }}"
