...
<body class="bg-slate-50 antialiased min-h-screen flex flex-col justify-between">
    ...
    <header class="site-header">
        <div class="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
            <a href="{{ url('/') }}" class="flex items-center gap-3">
                <img style="width:75px;height:75px;" src="{{ asset('public/images/matjarhub.png') }}" alt="MatjarHub">
            </a>

            <div class="hidden md:flex items-center gap-8 font-bold text-slate-600">
                <a href="{{ url('/') }}" class="hover:text-emerald-600 transition">الرئيسية</a>
                <a href="{{ url('/#pricing') }}" class="hover:text-emerald-600 transition">الباقات</a>
            ...
            <div class="flex items-center gap-3">
                <a href="{{ url('admin') }}" class="px-5 py-2.5 rounded-full text-emerald-600 font-bold bg-emerald-50 hover:bg-emerald-100 transition border border-emerald-200">
                    تسجيل الدخول
                </a>
                <a href="{{ url('admin/register') }}" class="px-5 py-2.5 rounded-full text-white font-bold gradient-bg shadow-md shadow-emerald-500/20 hover:opacity-95 transition">
                    أنشئ متجرك مجاناً
                </a>
            </div>
        </div>
        ...
        <section id="tutorials" class="max-w-7xl mx-auto px-6 py-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-lg transition-all group" data-aos="fade-up">
                    <div class="relative bg-slate-900 aspect-video flex items-center justify-center cursor-pointer" onclick="playVideo('{{ asset('public/videos/category.mp4') }}', 'إضافة فئة')">
                        <video class="w-full h-full object-cover opacity-70 group-hover:scale-105 transition duration-500" preload="metadata">
                            <source src="{{ asset('public/videos/category.mp4') }}#t=0.1" type="video/mp4">
                        </video>
                ...
                <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-lg transition-all group" data-aos="fade-up" data-aos-delay="100">
                    <div class="relative bg-slate-900 aspect-video flex items-center justify-center cursor-pointer" onclick="playVideo('{{ asset('public/videos/instgram.mp4') }}', 'إستيراد المنتجات من إنستجرام')">
                        <video class="w-full h-full object-cover opacity-70 group-hover:scale-105 transition duration-500" preload="metadata">
                            <source src="{{ asset('public/videos/instgram.mp4') }}#t=0.1" type="video/mp4">
                        </video>
                        <div class="absolute w-14 h-14 rounded-full bg-emerald-500 text-white flex items-center justify-center shadow-lg group-hover:scale-110 transition">
                            <span class="material-symbols-outlined text-3xl">play_arrow</span>
                        </div>
                ...
                <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-lg transition-all group" data-aos="fade-up" data-aos-delay="200">
                    <div class="relative bg-slate-900 aspect-video flex items-center justify-center cursor-pointer" onclick="playVideo('{{ asset('public/videos/logo.mp4') }}', 'تغيير اللوجو')">
                        <video class="w-full h-full object-cover opacity-70 group-hover:scale-105 transition duration-500" preload="metadata">
                            <source src="{{ asset('public/videos/logo.mp4') }}#t=0.1" type="video/mp4">
                        </video>
                        <div class="absolute w-14 h-14 rounded-full bg-emerald-500 text-white flex items-center justify-center shadow-lg group-hover:scale-110 transition">
                            <span class="material-symbols-outlined text-3xl">play_arrow</span>
                        </div>
                ...
                <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-lg transition-all group" data-aos="fade-up" data-aos-delay="300">
                    <div class="relative bg-slate-900 aspect-video flex items-center justify-center cursor-pointer" onclick="playVideo('{{ asset('public/videos/product.mp4') }}', 'إضافة منتج')">
                        <video class="w-full h-full object-cover opacity-70 group-hover:scale-105 transition duration-500" preload="metadata">
                            <source src="{{ asset('public/videos/product.mp4') }}#t=0.1" type="video/mp4">
                        </video>
                        <div class="absolute w-14 h-14 rounded-full bg-emerald-500 text-white flex items-center justify-center shadow-lg group-hover:scale-110 transition">
                            <span class="material-symbols-outlined text-3xl">play_arrow</span>
                        </div>
    ...
    <script>
        ...
        document.getElementById('aiForm').addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch("{{ route('landing2.ai.ask') }}", {
                    method: 'POST',
                    headers: {
