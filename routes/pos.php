...
Route::group(['namespace' => 'admin', 'prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => 'AuthMiddleware'], function () {
        ...
        Route::group(['prefix' => 'pos'], function () {
            ...
            Route::get('/cartview', [POSController::class, 'cartview']);
            Route::get('/cartview/delete-{id}', [POSController::class, 'cartviewdelete']);
            Route::post('/discount', [POSController::class, 'applydiscount']);
            Route::post('/remove-discount', [POSController::class, 'removeDiscount']);
            Route::post('/ordernow', [POSController::class, 'ordernow']);
            Route::get('/generateprint/{id}', [POSController::class, 'print']);
