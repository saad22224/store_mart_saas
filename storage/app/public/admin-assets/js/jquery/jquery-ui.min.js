...
(function(t, e) {
      ...
      function n(e, i, s, n) {
        return t.each(o, function() {
          (i -=
            ...
            0), s && (i -= parseFloat(t.css(e, "border" + this + "Width")) || 0), n && (i -= parseFloat(t.css(e, "margin" + this)) || 0);
        }), i;
      }
  ...
  (t.cleanData = function(e) {
    ...
    var o,
      ...
      c = i.split(".")[0];
    (i = i.split(".")[1]), (o = c + "-" + i), n ||
      ((n = s), (s = t.Widget)), (t.expr[":"][o.toLowerCase()] = function(e) {
      return !!t.data(e, o);
      ...
      _proto: t.extend({}, n),
      _childConstructors: []
    }), (h = new s()), (h.options = t.widget.extend(
      {},
      h.options
            ...
            (l[i] = (function() {
              ...
              return function() {
                var i,
                  s = this._super,
                  o = this._superApply;
                return (this._super = t), (this._superApply = e), (i = n.apply(
                  this,
                  arguments
                )), (this._super = s), (this._superApply = o), i;
              };
            })()),
            e
          )
    ...
    t.fn[i] = function(a) {
      var r = "string" == typeof a,
        ...
        l = this;
      return (a =
        !r && h.length ? t.widget.extend.apply(null, [a].concat(h)) : a), r
        ? this.each(function() {
            var s,
              n = t.data(this, o);
            return n
              ? t.isFunction(n[a]) && "_" !== a.charAt(0)
                ...
                : t.error(
                    "no such method '" + a + "' for " + i + " widget instance"
                  )
              : t.error(
    ...
    _createWidget: function(e, s) {
      (s = t(s || this.defaultElement || this)[0]), (this.element = t(
        ...
        "." + this.widgetName + this.uuid), (this.options = t.widget.extend(
        {},
        this.options,
        this._getCreateOptions(),
        e
      )), (this.bindings = t()), (this.hoverable = t()), (this.focusable = t()), s !==
        this &&
        (
    ...
    _on: function(i, s, n) {
      ...
      "boolean" != typeof i && ((n = s), (s = i), (i = !1)), n
        ...
        function h() {
          return i ||
          (a.options.disabled !== !0 && !t(this).hasClass("ui-state-disabled"))
    ...
    t.Widget.prototype["_" + e] = function(s, n, o) {
      ...
      (n = n || {}), "number" == typeof n &&
        ...
        n
      )), (n.complete = o), n.delay && s.delay(n.delay), a &&
      t.effects &&
      t.effects.effect[r]
        ? s[e](n)
        : r !== e && s[r]
  ...
  t.widget("ui.draggable", t.ui.mouse, {
    ...
    _create: function() {
      "original" !== this.options.helper ||
        ...
        (this.element[0].style.position = "relative"), this.options
        .addClasses && this.element.addClass("ui-draggable"), this.options
        .disabled &&
    ...
    _mouseStart: function(e) {
      var i = this.options;
      return (this.helper = this._createHelper(e)), this.helper.addClass(
        ...
        "position"
      )), (this.scrollParent = this.helper.scrollParent()), (this.offsetParent = this.helper.offsetParent()), (this.offsetParentCssPosition = this.offsetParent.css(
        "position"
        ...
        this._adjustOffsetFromHelper(
          i.cursorAt
        ), this._setContainment(), this._trigger("start", e) === !1
        ? (this._clear(), !1)
        : (
    ...
    _mouseStop: function(e) {
      ...
      return t.ui.ddmanager &&
        ...
        ((s = this.dropped), (this.dropped = !1)), "original" !==
        this.options.helper ||
    ...
    _mouseUp: function(e) {
      return t("div.ui-draggable-iframeFix").each(function() {
        ...
        t.ui.ddmanager.dragStop(this, e), t.ui.mouse.prototype._mouseUp.call(
        this,
        e
      );
    },
    ...
    _adjustOffsetFromHelper: function(e) {
      "string" == typeof e && (e = e.split(" ")), t.isArray(e) &&
        (e = { left: +e[0], top: +e[1] || 0 }), "left" in e &&
        (this.offset.click.left = e.left + this.margins.left), "right" in e &&
        (this.offset.click.left =
          this.helperProportions.width - e.right + this.margins.left), "top" in
    ...
    drag: function(e, i) {
      ...
      t.each(s.sortables, function() {
        ...
        (this.instance.positionAbs =
          s.positionAbs), (this.instance.helperProportions = s.helperProportions), (this.instance.offset.click = s.offset.click), this.instance._intersectsWith(
          ...
          (
            ...
            t.each(s.sortables, function() {
              return (this.instance.positionAbs =
                s.positionAbs), (this.instance.helperProportions = s.helperProportions), (this.instance.offset.click = s.offset.click), this !== a && this.instance._intersectsWith(this.instance.containerCache) && t.contains(a.instance.element[0], this.instance.element[0]) && (o = !1), o;
            })
          ), o
          ? (
              this.instance.isOver ||
    ...
    drag: function(e, i) {
      ...
      for (u = p.snapElements.length - 1; u >= 0; u--)
        (r = p.snapElements[u].left), (h = r + p.snapElements[u].width), (l =
          p.snapElements[u].top), (c = l + p.snapElements[u].height), r - g >
          v ||
        m > h + g ||
        l - g > b ||
        _ > c + g ||
  ...
  t.widget("ui.droppable", {
    ...
    _create: function() {
      ...
      (this.isover = !1), (this.isout = !0), (this.accept = t.isFunction(i)
        ...
        t.ui.ddmanager.droppables[e.scope] || []), t.ui.ddmanager.droppables[
        e.scope
      ].push(this), e.addClasses && this.element.addClass("ui-droppable");
    },
    _destroy: function() {
      for (
    ...
    switch (s) {
      ...
      case "pointer":
        return (n =
          ...
          (t.clickOffset || t.offset.click).left), (o =
          (t.positionAbs || t.position.absolute).top +
          (t.clickOffset || t.offset.click).top), e(
          o,
          d,
    ...
    prepareOffsets: function(e, i) {
      ...
      t: for (s = 0; o.length > s; s++)
        if (
          ...
          (o[s].visible = "none" !== o[s].element.css("display")), o[s]
            .visible &&
            (
    ...
    drag: function(e, i) {
      e.options.refreshPositions &&
        t.ui.ddmanager.prepareOffsets(e, i), t.each(
    ...
    dragStop: function(e, i) {
      e.element.parentsUntil("body").unbind("scroll.droppable"), e.options
        .refreshPositions || t.ui.ddmanager.prepareOffsets(e, i);
    }
  });
})(jQuery), (function(t) {
  function e(t) {
  ...
  t.widget("ui.resizable", t.ui.mouse, {
    ...
    _create: function() {
      ...
      if (
        ...
        for (
          "all" === this.handles &&
            (this.handles = "n,e,s,w,se,sw,ne,nw"), e = this.handles.split(
            ","
          ), this.handles = {}, i = 0;
          e.length > i;
          i++
        )
          (s = t.trim(e[i])), (o = "ui-resizable-" + s), (n = t(
      ...
      (this._renderAxis = function(e) {
        ...
        for (i in this.handles)
          this.handles[i].constructor === String &&
            (this.handles[i] = t(this.handles[i], this.element).show()), this
            .elementIsWrapper &&
    ...
    _mouseCapture: function(e) {
      var i,
        ...
        n = !1;
      for (i in this.handles)
        (s = t(this.handles[i])[0]), (s === e.target ||
    ...
    _mouseStart: function(i) {
      var s,
        ...
        h = this.element;
      return (this.resizing = !0), /absolute/.test(h.css("position"))
        ? h.css({
            position: "absolute",
            top: h.css("top"),
            left: h.css("left")
        ...
        : h.is(".ui-draggable") &&
          h.css({
            ...
            top: r.top,
            left: r.left
          }), this._renderProxy(), (s = e(this.helper.css("left"))), (n = e(
        this.helper.css("top")
      )), a.containment &&
        (
        ...
        : { width: h.width(), height: h.height() }), (this.originalSize = this
        ._helper
        ? { width: h.outerWidth(), height: h.outerHeight() }
        ...
        "number" == typeof a.aspectRatio
          ? a.aspectRatio
          : this.originalSize.width / this.originalSize.height || 1), (o = t(
        ".ui-resizable-" + this.axis
      ).css("cursor")), t("body").css(
        "cursor",
    ...
    _mouseStop: function(e) {
      ...
      return this._helper &&
        ...
        ), t("body").css("cursor", "auto"), this.element.removeClass(
    ...
    _respectSize: function(t) {
      ...
      return a && (t.width = e.minWidth), r && (t.height = e.minHeight), n &&
        ...
        c &&
        (t.left = h - e.minWidth), n && c && (t.left = h - e.maxWidth), r &&
        u &&
        (t.top = l - e.minHeight), o &&
        u &&
        (t.top = l - e.maxHeight), t.width || t.height || t.left || !t.top
    ...
    stop: function(e) {
      ...
      i.element.animate(t.extend(h, c && l ? { top: c, left: l } : {}), {
        ...
        step: function() {
          ...
          n &&
            n.length &&
            t(n[0]).css({ width: s.width, height: s.height }), i._updateCache(
            s
    ...
    start: function() {
      var i,
        ...
        d = c.containment,
        p =
          d instanceof t ? d.get(0) : /parent/.test(d) ? u.parent().get(0) : d;
      p &&
        (
    ...
    resize: function(e) {
      ...
      d[0] !== document && /static/.test(d.css("position")) && (u = h), l.left <
        ...
        a.parentData.left + a.position.left), (a.offset.top =
        a.parentData.top + a.position.top), (i = Math.abs(
      ...
      )), n && o && (i -= a.parentData.left), i + a.size.width >=
        a.parentData.width &&
        (
    ...
    start: function() {
      var e = t(this).data("ui-resizable"),
        i = e.options,
        s = e.size;
      (e.ghost = e.originalElement.clone()), e.ghost
        .css({
          opacity: 0.25,
          display: "block",
          position: "relative",
        ...
        .addClass("string" == typeof i.ghost ? i.ghost : ""), e.ghost.appendTo(
        e.helper
      );
    },
    resize: function() {
  ...
  t.widget("ui.selectable", t.ui.mouse, {
    ...
    _create: function() {
      ...
      this.element.addClass(
        ...
        (e = t(i.options.filter, i.element[0])), e.addClass(
          "ui-selectee"
        ), e.each(function() {
          var e = t(this),
            i = e.offset();
      ...
      }), this.refresh(), (this.selectees = e.addClass(
        "ui-selectee"
      )), this._mouseInit(), (this.helper = t(
    ...
    _mouseStop: function(e) {
      ...
      return (this.dragged = !1), t(
        ...
        s.$element.removeClass(
          "ui-unselecting"
        ), (s.unselecting = !1), (s.startselected = !1), i._trigger("unselected", e, { unselected: s.element });
        ...
        s.$element
          ...
          .addClass(
            "ui-selected"
          ), (s.selecting = !1), (s.selected = !0), (s.startselected = !0), i._trigger("selected", e, { selected: s.element });
  ...
  t.widget("ui.sortable", t.ui.mouse, {
    ...
    _create: function() {
      ...
      (this.containerCache = {}), this.element.addClass(
        "ui-sortable"
      ), this.refresh(), (this.floating = this.items.length
        ? "x" === t.axis || i(this.items[0].item)
        : !1), (this.offset = this.element.offset()), this._mouseInit(), (this.ready = !0);
    },
    _destroy: function() {
      this.element.removeClass(
    ...
    _mouseStart: function(e, i, s) {
      ...
      return t.ui.ddmanager && (t.ui.ddmanager.current = this), t.ui
        .ddmanager &&
        !a.dropBehaviour &&
    ...
    refreshPositions: function(e) {
      ...
      if (this.options.custom && this.options.custom.refreshContainers)
        ...
        for (i = this.containers.length - 1; i >= 0; i--)
          (o = this.containers[i].element.offset()), (this.containers[
            i
          ].containerCache.left =
            o.left), (this.containers[i].containerCache.top =
            o.top), (this.containers[i].containerCache.width = this.containers[
            i
    ...
    _createPlaceholder: function(e) {
      ...
      )), e.currentItem.after(e.placeholder), s.placeholder.update(
        e,
        e.placeholder
      );
    },
    _contactContainers: function(s) {
      ...
      if (f)
        if (1 === this.containers.length)
          ...
          for (
            a = 1e4, r = null, p = f.floating || i(this.currentItem), h = p
              ? "left"
              : "top", l = p ? "width" : "height", c =
              this.positionAbs[h] + this.offset.click[h], o =
              this.items.length - 1;
            o >= 0;
            o--
          )
          ...
          r
            ...
            : this._rearrange(
                ...
                !0
              ), this._trigger("change", s, this._uiHash()), this.containers[
            g
          ]._trigger(
            "change",
            s,
    ...
    (p.style.cssText = "background-color:rgba(1,1,1,.5)"), (d.rgba =
      ...
      return (e =
        h === r
          ...
          : s === r
            ? 60 * (n - o) / l + 360
            : n === r ? 60 * (o - s) / l + 120 : 60 * (s - n) / l + 240), (i =
    ...
    t.extend(t.effects, {
      ...
      createWrapper: function(e) {
        ...
        return e.wrap(s), (e[0] === o || t.contains(e[0], o)) &&
          t(o).focus(), (s = e.parent()), "static" === e.css("position")
  ...
  (i.height = i.paddingTop = i.paddingBottom = i.borderTopWidth = i.borderBottomWidth =
    "hide"), (s.height = s.paddingTop = s.paddingBottom = s.borderTopWidth = s.borderBottomWidth =
        ...
        .each(function(e) {
          ...
          s ||
            (
              (s = a + "-header-" + e),
              i.attr("id", s)
            ), o || ((o = a + "-panel-" + e), n.attr("id", o)), i.attr("aria-controls", o), n.attr("aria-labelledby", s);
        })
        .next()
    ...
    _eventHandler: function(e) {
      ...
      e.preventDefault(), (o && !i.collapsible) ||
    ...
    _toggle: function(e) {
      ...
      this.prevShow
        ...
        "aria-expanded": "false",
        "aria-hidden": "true"
      }), s.prev().attr("aria-selected", "false"), i.length && s.length
    ...
    _animate: function(t, e, n) {
      ...
      return "number" == typeof d && (r = d), "string" == typeof d &&
        (a = d), (a = a || d.easing || u.easing), (r =
        r || d.duration || u.duration), e.length
        ? t.length
          ? (
  ...
  t.widget("ui.autocomplete", {
    ...
    search: function(t, e) {
      return (t =
        null != t ? t : this._value()), (this.term = this._value()), t.length <
      this.options.minLength
        ? this.close(e)
        : this._trigger("search", e) !== !1 ? this._search(t) : undefined;
    },
    _search: function(t) {
  ...
  t.widget("ui.button", {
    ...
    _create: function() {
      this.element
        ...
        .bind("reset" + this.eventNamespace, h), "boolean" !=
    ...
    refresh: function() {
      ...
      e !== this.options.disabled && this._setOption("disabled", e), "radio" ===
      this.type
    ...
    _setOption: function(t, e) {
      "disabled" === t && this.buttons.button("option", t, e), this._super(
        t,
        e
      );
    },
  ...
  function i() {
    (this._curInst = null), (this._keyEvent = !1), (this._disabledInputs = []), (this._datepickerShowing = !1), (this._inDialog = !1), (this._mainDivId =
      ...
      autoSize: !1,
      disabled: !1
    }), t.extend(this._defaults, this.regional[""]), (this.dpDiv = s(
      t(
        "<div id='" +
          this._mainDivId +
  ...
  t.extend(i.prototype, {
    ...
    _attachDatepicker: function(e, i) {
      ...
      (s = e.nodeName.toLowerCase()), (n = "div" === s || "span" === s), e.id ||
        ((this.uuid += 1), (e.id = "dp" + this.uuid)), (o = this._newInst(
        t(e),
        n
      )), (o.settings = t.extend({}, i || {})), "input" === s
    ...
    _attachments: function(e, i) {
      ...
      i.append && i.append.remove(), a &&
        ...
        ), e.unbind("focus", this._showDatepicker), i.trigger &&
    ...
    _dialogDatepicker: function(e, i, s, o, r) {
      ...
      return p ||
        ...
        i && i.constructor === Date
          ...
          : i), this._dialogInput.val(i), (this._pos = r
        ...
        .css(
          "top",
          this._pos[1] + "px"
        ), (p.settings.onSelect = s), (this._inDialog = !0), this.dpDiv.addClass(
        this._dialogClass
      ), this._showDatepicker(this._dialogInput[0]), t.blockUI &&
    ...
    _optionDatepicker: function(i, s, o) {
      ...
      return 2 === arguments.length && "string" == typeof s
        ? "defaults" === s
          ...
          : c
            ? "all" === s ? t.extend({}, c.settings) : this._get(c, s)
            : null
        : (
            (a = s || {}),
    ...
    _getDateDatepicker: function(t, e) {
      var i = this._getInst(t);
      return i && !i.inline && this._setDateFromField(i, e), i
        ? this._getDate(i)
        : null;
    },
      ...
      if (((o._keyEvent = !0), t.datepicker._datepickerShowing))
        switch (e.keyCode) {
          ...
          case 13:
            return (n = t(
              ...
              t.datepicker._selectDay(
                ...
                o.selectedYear,
                n[0]
              ), (i = t.datepicker._get(o, "onSelect")), i
              ? (
          ...
          case 34:
            ...
            break;
          case 35:
            (e.ctrlKey || e.metaKey) && t.datepicker._clearDate(e.target), (a =
              e.ctrlKey || e.metaKey);
            break;
          case 36:
            (e.ctrlKey || e.metaKey) && t.datepicker._gotoToday(e.target), (a =
              e.ctrlKey || e.metaKey);
            break;
          case 37:
            (e.ctrlKey || e.metaKey) &&
              t.datepicker._adjustDate(e.target, r ? 1 : -1, "D"), (a =
          ...
          case 38:
            (e.ctrlKey || e.metaKey) &&
              t.datepicker._adjustDate(e.target, -7, "D"), (a =
              e.ctrlKey || e.metaKey);
            break;
          case 39:
            (e.ctrlKey || e.metaKey) &&
    ...
    _showDatepicker: function(e) {
      if (
        ...
        (i = t.datepicker._getInst(e)), t.datepicker._curInst &&
          ...
          ), (s = t.datepicker._get(i, "beforeShow")), (o = s
          ? s.apply(e, [e, i])
          : {}), o !== !1 &&
          (
            n(i.settings, o),
    ...
    _updateDatepicker: function(e) {
      (this.maxRows = 4), (o = e), e.dpDiv
        .empty()
        .append(this._generateHTML(e)), this._attachHandlers(e), e.dpDiv
      ...
      e.dpDiv
        ...
        e.dpDiv
          ...
          .css("width", a * n + "em"), e.dpDiv[
        (1 !== s[0] || 1 !== s[1] ? "add" : "remove") + "Class"
      ]("ui-datepicker-multi"), e.dpDiv[
        (this._get(e, "isRTL") ? "add" : "remove") + "Class"
      ]("ui-datepicker-rtl"), e === t.datepicker._curInst &&
        t.datepicker._datepickerShowing &&
        t.datepicker._shouldFocusInput(e) &&
        e.input.focus(), e.yearshtml &&
        (
          (i = e.yearshtml),
          setTimeout(function() {
            i === e.yearshtml &&
    ...
    _selectDate: function(e, i) {
      ...
      (i = null != i ? i : this._formatDate(o)), o.input &&
        o.input.val(i), this._updateAlternate(o), (s = this._get(
        o,
        "onSelect"
      )), s
    ...
    iso8601Week: function(t) {
      ...
      ), (e = i.getTime()), i.setMonth(0), i.setDate(1), Math.floor(
        Math.round((e - i) / 864e5) / 7
      ) + 1;
    },
        ...
        if (y) "'" !== i.charAt(o) || w("'") ? D() : (y = !1);
          ...
          switch (i.charAt(o)) {
            ...
            case "y":
              ...
              break;
            case "@":
              (h = new Date(k("@"))), (m = h.getFullYear()), (v =
                h.getMonth() + 1), (_ = h.getDate());
              break;
            case "!":
              (h = new Date(
    ...
    _generateHTML: function(t) {
      ...
      if ((0 > Z && ((Z += 12), te--), J))
        for (
          ...
          Z--, 0 > Z && ((Z = 11), te--);
      for (
        t.drawMonth = Z, t.drawYear = te, i = this._get(t, "prevText"), i = K
          ? this.formatDate(
              i,
          ...
          : V
            ...
            : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" +
              ...
              "'>" +
              i +
              "</span></a>", n = this._get(t, "nextText"), n = K
          ? this.formatDate(
              n,
              this._daylightSavingAdjust(new Date(te, Z + Q, 1)),
              this._getFormatConfig(t)
          ...
          this._get(t, "gotoCurrent") && t.currentDay ? $ : j, a = K
          ...
          ? 0
          : c, u = this._get(t, "showWeek"), d = this._get(
          t,
          "dayNames"
        ), p = this._get(t, "dayNamesMin"), f = this._get(
          t,
          "monthNames"
        ), g = this._get(t, "monthNamesShort"), m = this._get(
          t,
          "beforeShowDay"
        ), v = this._get(t, "showOtherMonths"), _ = this._get(
          t,
          "selectOtherMonths"
        ), b = this._getDefaultDate(t), y = "", k = 0;
        U[0] > k;
        k++
      ) {
        for (x = "", this.maxRows = 4, D = 0; U[1] > D; D++) {
          if (
            ...
            if (((P += "<div class='ui-datepicker-group"), U[1] > 1))
              switch (D) {
                case 0:
                  (P += " ui-datepicker-group-first"), (I =
                    " ui-corner-" + (Y ? "right" : "left"));
                  break;
                case U[1] - 1:
                  (P += " ui-datepicker-group-last"), (I =
          ...
          for (
            ...
            (M = (w + c) % 7), (T +=
              ...
              "</span></th>");
          for (
            P += T + "</tr></thead><tbody>", S = this._getDaysInMonth(
              te,
              Z
            ), te === t.selectedYear &&
              Z === t.selectedMonth &&
              (t.selectedDay = Math.min(t.selectedDay, S)), z =
              (this._getFirstDayOfMonth(te, Z) - c + 7) % 7, A = Math.ceil(
              (z + S) / 7
            ), H = X
              ? this.maxRows > A ? this.maxRows : A
              : A, this.maxRows = H, E = this._daylightSavingAdjust(
              new Date(te, Z, 1 - z)
            ), N = 0;
            H > N;
            N++
                  ...
                  : R
                    ...
                    : "<a class='ui-state-default" +
                      (E.getTime() === j.getTime()
                        ? " ui-state-highlight"
                        : "") +
                      (E.getTime() === $.getTime() ? " ui-state-active" : "") +
    ...
    _generateMonthYearHeader: function(t, e, i, s, n, o, a, r) {
      ...
      if (o || !m) y += "<span class='ui-datepicker-month'>" + a[e] + "</span>";
        ...
        for (
          h = s && s.getFullYear() === i, l = n && n.getFullYear() === i, y +=
            "<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>", c = 0;
          12 > c;
          c++
        )
          (!h || c >= s.getMonth()) &&
        ...
        if (((t.yearshtml = ""), o || !v))
          ...
          for (
            u = this._get(t, "yearRange").split(
              ":"
            ), d = new Date().getFullYear(), p = function(t) {
              var e = t.match(/c[+\-].*/)
              ...
              : f, g = n ? Math.min(g, n.getFullYear()) : g, t.yearshtml +=
            ...
            t.yearshtml +=
              ...
              f +
              "</option>";
          (t.yearshtml += "</select>"), (b +=
            t.yearshtml), (t.yearshtml = null);
        }
  ...
  t.widget("ui.dialog", {
    ...
    _create: function() {
      (this.originalCss = {
        ...
        t.fn.resizable &&
        this._makeResizable(), (this._isOpen = !1);
    },
    _init: function() {
    ...
    _destroy: function() {
      ...
      this._destroyOverlay(), this.element
        .removeUniqueId()
        ...
        this.element.attr(
          "title",
          this.originalTitle
        ), (t = e.parent.children().eq(e.index)), t.length &&
      t[0] !== this.element[0]
    ...
    _makeDraggable: function() {
      ...
      this.uiDialog.draggable({
        ...
        start: function(s, n) {
          t(this).addClass("ui-dialog-dragging"), i._blockFrames(), i._trigger(
            "dragStart",
            s,
            e(n)
          );
        ...
        stop: function(n, o) {
          (s.position = [
            ...
            "ui-dialog-dragging"
          ), i._unblockFrames(), i._trigger("dragStop", n, e(o));
        }
      });
    },
      ...
      this.uiDialog
        .resizable({
          ...
          start: function(s, n) {
            t(this).addClass(
              "ui-dialog-resizing"
            ), i._blockFrames(), i._trigger("resizeStart", s, e(n));
          },
          resize: function(t, s) {
            i._trigger("resize", t, e(s));
          },
          stop: function(n, o) {
            (s.height = t(this).height()), (s.width = t(this).width()), t(
              this
            ).removeClass("ui-dialog-resizing"), i._unblockFrames(), i._trigger(
              "resizeStop",
              n,
              e(o)
            );
    ...
    _setOptions: function(s) {
      ...
      }), o && (this._size(), this._position()), this.uiDialog.is(
        ":data(ui-resizable)"
    ...
    _size: function() {
      ...
      this.element
        ...
        (s.width = s.minWidth), (t = this.uiDialog
        .css({ height: "auto", width: s.width })
        .outerHeight()), (e = Math.max(0, s.minHeight - t)), (i =
    ...
    t.widget("ui.dialog", t.ui.dialog, {
      _position: function() {
        ...
        i
          ...
          : (i = t.ui.dialog.prototype.options.position), (e = this.uiDialog.is(
          ":visible"
        )), e || this.uiDialog.show(), this.uiDialog.position(i), e ||
          this.uiDialog.hide();
      }
    });
})(jQuery), (function(t) {
  ...
  t.effects.effect.blind = function(s, n) {
    ...
    h.parent().is(".ui-effects-wrapper")
      ...
      .createWrapper(h)
      .css({ overflow: "hidden" })), (a = o[p]()), (r =
      parseFloat(o.css(f)) || 0), (m[p] = v ? a : 0), g ||
      (
        h
      ...
      queue: !1,
      complete: function() {
        "hide" === c && h.hide(), t.effects.restore(
          h,
          l
  ...
  t.effects.effect.bounce = function(e, i) {
    var s,
      ...
      y = b.length;
    for (
      (c || l) && r.push("opacity"), t.effects.save(
        a,
        r
      ), a.show(), t.effects.createWrapper(a), d ||
    ...
    l &&
      ...
      b.splice.apply(b, [1, 0].concat(b.splice(y, f + 1))), a.dequeue();
  };
})(jQuery), (function(t) {
  t.effects.effect.clip = function(e, i) {
    var s,
      ...
      p = u ? "top" : "left",
      f = {};
    t.effects.save(a, r), a.show(), (s = t.effects
      .createWrapper(a)
      .css({ overflow: "hidden" })), (n =
      "IMG" === a[0].tagName ? s : a), (o = n[d]()), l &&
  ...
  t.effects.effect.drop = function(e, i) {
    var s,
      ...
      u = { opacity: r ? 1 : 0 };
    t.effects.save(n, o), n.show(), t.effects.createWrapper(n), (s =
      e.distance || n["top" === l ? "outerHeight" : "outerWidth"](!0) / 2), r &&
      n.css("opacity", 0).css(l, "pos" === c ? -s : s), (u[l] =
      (r ? ("pos" === c ? "+=" : "-=") : "pos" === c ? "-=" : "+=") +
      s), n.animate(u, {
      queue: !1,
      duration: e.duration,
      easing: e.easing,
      complete: function() {
        "hide" === a && n.hide(), t.effects.restore(
          n,
          o
  ...
  t.effects.effect.fold = function(e, i) {
    var s,
      ...
      m = {},
      v = {};
    t.effects.save(o, a), o.show(), (s = t.effects
      .createWrapper(o)
      .css({ overflow: "hidden" })), (n = p
      ? [s.width(), s.height()]
      : [s.height(), s.width()]), u &&
      (c = parseInt(u[1], 10) / 100 * n[l ? 0 : 1]), h &&
      s.css(d ? { height: 0, width: c } : { height: c, width: 0 }), (m[f[0]] = h
      ? n[0]
      : c), (v[f[1]] = h ? n[1] : 0), s
  ...
  t.effects.effect.highlight = function(e, i) {
    ...
    "hide" === o && (a.opacity = 0), t.effects.save(s, n), s
      .show()
  ...
  t.effects.effect.pulsate = function(e, i) {
    ...
    n.animate({ opacity: u }, c, e.easing), n.queue(function() {
      ...
      d.splice.apply(d, [1, 0].concat(d.splice(p, l + 1))), n.dequeue();
  };
})(jQuery), (function(t) {
  (t.effects.effect.puff = function(e, i) {
    ...
    "show" === p && a.show(), (s = {
      ...
      ), t.effects.save(a, _), a.show(), t.effects.createWrapper(a), a
      .css("overflow", "hidden")
      .css(a.from), m &&
      (
        ...
        a.find("*[width]").each(function() {
          ...
          f &&
            t.effects.save(
              i,
              l
            ), (i.from = { height: s.height * o.from.y, width: s.width * o.from.x, outerHeight: s.outerHeight * o.from.y, outerWidth: s.outerWidth * o.from.x }), (i.to = { height: s.height * o.to.y, width: s.width * o.to.x, outerHeight: s.height * o.to.y, outerWidth: s.width * o.to.x }), o.from.y !== o.to.y && ((i.from = t.effects.setTransition(i, u, o.from.y, i.from)), (i.to = t.effects.setTransition(i, u, o.to.y, i.to))), o.from.x !== o.to.x && ((i.from = t.effects.setTransition(i, d, o.from.x, i.from)), (i.to = t.effects.setTransition(i, d, o.to.x, i.to))), i.css(i.from), i.animate(
            i.to,
            e.duration,
            e.easing,
            function() {
  ...
  t.effects.effect.shake = function(e, i) {
    var s,
      ...
      _ = v.length;
    for (
      t.effects.save(n, o), n.show(), t.effects.createWrapper(n), f[d] =
        (p ? "-=" : "+=") + h, g[d] = (p ? "+=" : "-=") + 2 * h, m[d] =
        (p ? "-=" : "+=") + 2 * h, n.animate(f, u, e.easing), s = 1;
      l > s;
      s++
    )
    ...
    n.animate(g, u, e.easing).animate(f, u / 2, e.easing).queue(function() {
      "hide" === a &&
        n.hide(), t.effects.restore(n, o), t.effects.removeWrapper(n), i();
    }), _ > 1 &&
      v.splice.apply(v, [1, 0].concat(v.splice(_, c + 1))), n.dequeue();
  };
})(jQuery), (function(t) {
  t.effects.effect.slide = function(e, i) {
    var s,
      ...
      c = "up" === h || "left" === h,
      u = {};
    t.effects.save(n, o), n.show(), (s =
      e.distance ||
      n["top" === l ? "outerHeight" : "outerWidth"](
        !0
      )), t.effects.createWrapper(n).css({ overflow: "hidden" }), r &&
      n.css(l, c ? (isNaN(s) ? "-" + s : -s) : s), (u[l] =
      (r ? (c ? "+=" : "-=") : c ? "-=" : "+=") + s), n.animate(u, {
      queue: !1,
      duration: e.duration,
      easing: e.easing,
  ...
  t.widget("ui.menu", {
    ...
    _keydown: function(e) {
      ...
      switch (e.keyCode) {
        ...
        case t.ui.keyCode.ESCAPE:
          ...
          break;
        default:
          (h = !1), (n = this.previousFilter || ""), (o = String.fromCharCode(
            e.keyCode
          )), (a = !1), clearTimeout(this.filterTimer), o === n
            ? (a = !0)
            : (o = n + o), (r = RegExp(
            "^" + i(o),
            "i"
    ...
    refresh: function() {
      ...
      s
        ...
        .attr({ tabIndex: -1, role: this._itemRole() }), e
        .children(":not(.ui-menu-item)")
        .each(function() {
          var e = t(this);
          /[^\-\u2014\u2013\s]/.test(e.text()) ||
            e.addClass("ui-widget-content ui-menu-divider");
        }), e.children(".ui-state-disabled").attr("aria-disabled", "true"), this
        .active &&
    ...
    focus: function(t, e) {
      ...
      this.blur(t, t && "focus" === t.type), this._scrollIntoView(
        e
      ), (this.active = e.first()), (s = this.active
        .children("a")
    ...
    collapseAll: function(e, i) {
      clearTimeout(this.timer), (this.timer = this._delay(function() {
        ...
        s.length ||
          (s = this
            .element), this._close(s), this.blur(e), (this.activeMenu = s);
      }, this.delay));
    },
    _close: function(t) {
    ...
    _move: function(t, e, i) {
      ...
      this.active &&
        ...
        s.length &&
        this.active) ||
        (s = this.activeMenu.children(".ui-menu-item")[e]()), this.focus(i, s);
    },
    nextPage: function(e) {
      var i, s, n;
      return this.active
  ...
  (t.position = {
    scrollbarWidth: function() {
      ...
      var i,
        ...
        a = n.children()[0];
      return t("body").append(n), (i = a.offsetWidth), n.css(
        "overflow",
        "scroll"
      ), (s = a.offsetWidth), i === s &&
    ...
    var o,
      ...
      x = {};
    return (_ = n(b)), b[0].preventDefault && (e.at = "left top"), (p =
      _.width), (g = _.height), (m = _.offset), (v = t.extend({}, m)), t.each(
      ["my", "at"],
      function() {
        var t,
          i,
        ...
        1 === s.length &&
          ...
          ? s[0]
          : "center"), (s[1] = c.test(s[1]) ? s[1] : "center"), (t = u.exec(
          s[0]
        )), (i = u.exec(s[1])), (x[this] = [t ? t[0] : 0, i ? i[0] : 0]), (e[
          this
      ...
      "right" === e.my[0]
        ...
        : "center" === e.my[0] &&
          (I.left -=
            u /
            2), "bottom" === e.my[1] ? (I.top -= d) : "center" === e.my[1] && (I.top -= d / 2), (I.left += P[0]), (I.top += P[1]), t.support.offsetFractions || ((I.left = h(I.left)), (I.top = h(I.top))), (n = { marginLeft: f, marginTop: _ }), t.each(
        ["left", "top"],
        function(i, s) {
          t.ui.position[k[i]] &&
    ...
    fit: {
      left: function(t, e) {
        ...
        e.collisionWidth > o
          ...
          : h > 0
            ? (t.left += h)
            : l > 0 ? (t.left -= l) : (t.left = a(t.left - r, t.left));
      },
      top: function(t, e) {
        var i,
          s = e.within,
        ...
        e.collisionHeight > o
          ...
          : h > 0
            ? (t.top += h)
            : l > 0 ? (t.top -= l) : (t.top = a(t.top - r, t.top));
      }
    },
    flip: {
      left: function(t, e) {
    ...
    (e = document.createElement(a ? "div" : "body")), (s = {
      ...
      t.extend(s, { position: "absolute", left: "-1000px", top: "-1000px" });
    for (o in s) e.style[o] = s[o];
    e.appendChild(r), (i = a || document.documentElement), i.insertBefore(
      e,
      i.firstChild
    ), (r.style.cssText = "position: absolute; left: 10.7432222px;"), (n = t(
      r
    ).offset().left), (t.support.offsetFractions =
  ...
  t.widget("ui.progressbar", {
    ...
    _constrainedValue: function(t) {
      return t === e && (t = this.options.value), (this.indeterminate =
    ...
    _refreshValue: function() {
      ...
      this.valueDiv
        ...
        ((this.oldValue = e), this._trigger("change")), e ===
  ...
  t.widget("ui.slider", t.ui.mouse, {
    ...
    _setupEvents: function() {
      ...
      this._off(t), this._on(t, this._handleEvents), this._hoverable(
        t
      ), this._focusable(t);
    },
    _destroy: function() {
    ...
    _normValueFromMouse: function(t) {
      ...
      return "horizontal" === this.orientation
        ...
        : (
          ...
          ), (s = i / e), s > 1 && (s = 1), 0 > s && (s = 0), "vertical" ===
        this.orientation && (s = 1 - s), (n =
        this._valueMax() - this._valueMin()), (o =
        this._valueMin() + s * n), this._trimAlignValue(o);
    },
    _start: function(t, e) {
      var i = { handle: this.handles[e], value: this.value() };
      return this.options.values &&
        this.options.values.length &&
        ((i.value = this.values(e)), (i.values = this.values())), this._trigger(
        "start",
        t,
        i
      );
    ...
    values: function(e, i) {
      ...
      if (arguments.length > 1)
        return (this.options.values[e] = this._trimAlignValue(
          i
  ...
  t.widget("ui.spinner", {
    ...
    _create: function() {
      this._setOption("max", this.options.max), this._setOption(
        "min",
        this.options.min
      ), this._setOption("step", this.options.step), this._value(
        this.element.val(),
        !0
      ), this._draw(), this._on(this._events), this._refresh(), this._on(
        this.window,
        {
          beforeunload: function() {
            this.element.removeAttr("autocomplete");
    ...
    _draw: function() {
      ...
      this.element.attr("role", "spinbutton"), (this.buttons = t
        ...
        Math.ceil(0.5 * t.height()) &&
        t.height() > 0 &&
        t.height(t.height()), this.options.disabled && this.disable();
    },
    _keydown: function(e) {
      var i = this.options,
        s = t.ui.keyCode;
    ...
    _adjustValue: function(t) {
      ...
      return (e = null !== s.min ? s.min : 0), (i = t - e), (i =
        Math.round(i / s.step) * s.step), (t = e + i), (t = parseFloat(
  ...
  t.widget("ui.tabs", {
      ...
      if (!this._handlePageNav(i)) {
        switch (i.keyCode) {
          ...
          case t.ui.keyCode.HOME:
            ...
            break;
          case t.ui.keyCode.SPACE:
            return i.preventDefault(), clearTimeout(
              this.activating
            ), this._activate(n), e;
          case t.ui.keyCode.ENTER:
            return i.preventDefault(), clearTimeout(
        ...
        i.preventDefault(), clearTimeout(
          this.activating
        ), (n = this._focusNextTab(n, o)), i.ctrlKey ||
          (
    ...
    _refresh: function() {
      this._setupDisabled(this.options.disabled), this._setupEvents(
        ...
        .not(this.active)
        .attr({ "aria-selected": "false", tabIndex: -1 }), this.panels
        .not(this._getPanelForTab(this.active))
        .hide()
        .attr({ "aria-expanded": "false", "aria-hidden": "true" }), this.active
        .length
        ? (
            this.active
      ...
      (this.tablist = this._getList()
        ...
        s(n)
          ...
          : (
            ...
            ), a.length && (e.panels = e.panels.add(a)), c && l.data("ui-tabs-aria-controls", c), l.attr({ "aria-controls": o.substring(1), "aria-labelledby": h }), a.attr("aria-labelledby", h);
      }), this.panels
    ...
    _setupEvents: function(e) {
      ...
      e &&
        ...
        this.anchors,
        i
      ), this._on(this.tabs, { keydown: "_tabKeydown" }), this._on(
        this.panels,
        { keydown: "_panelKeydown" }
    ...
    _toggle: function(e, i) {
      ...
      (this.running = !0), r.length && this.options.hide
        ...
        "aria-expanded": "false",
        "aria-hidden": "true"
      }), i.oldTab.attr("aria-selected", "false"), a.length && r.length
    ...
    _getIndex: function(t) {
      return "string" == typeof t &&
        (t = this.anchors.index(this.anchors.filter("[href$='" + t + "']"))), t;
    },
    _destroy: function() {
                  ...
                  setTimeout(function() {
                    "abort" === e &&
                      n.panels.stop(
                        !1,
                        !0
                      ), o.removeClass("ui-tabs-loading"), r.removeAttr("aria-busy"), t === n.xhr && delete n.xhr;
                  }, 1);
                })
            )
        );
  ...
  t.widget("ui.tooltip", {
    ...
    _open: function(i, s, n) {
      ...
      if (n) {
        ...
        s.is("[title]") &&
          ...
          s,
          a.attr("id")
        ), a.find(".ui-tooltip-content").html(n), this.options.track &&
        i &&
        /^mouse/.test(i.type)
          ? (this._on(this.document, { mousemove: o }), o(i))
          : a.position(
              t.extend({ of: s }, this.options.position)
            ), a.hide(), this._show(a, this.options.show), this.options.show &&
          ...
          "focusin" !== i.type) ||
          (r.focusout = "close"), this._on(!0, s, r);
      }
    },
    close: function(e) {
      var s = this,
    ...
    _tooltip: function(e) {
      ...
      return t("<div>").addClass("ui-tooltip-content").appendTo(n), n.appendTo(
