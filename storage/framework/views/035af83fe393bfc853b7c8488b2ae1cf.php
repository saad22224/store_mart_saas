...
<section class="header-10">
    <div class="container">
        <div class="text-center">
            <!-- title -->
            <h1 class="title color-changer text-dark"><?php echo e(helper::appdata($storeinfo->id)->website_title); ?></h1>
            <!-- sub title -->
            <p class="sub-title"><a href="mailto:<?php echo e(helper::appdata($storeinfo->id)->email); ?>"
                    class="call color-changer"><?php echo e(helper::appdata($storeinfo->id)->email); ?></a></p>
            <!-- contact -->
            <a href="tel:<?php echo e(helper::appdata($storeinfo->id)->contact); ?>" target="_blank" class="d-block mb-3">
                <span class="mx-2 color-changer call"><?php echo e(helper::appdata($storeinfo->id)->contact); ?></span>
            </a>
            <!-- social-media -->
                        ...
                        <div class="col">
                            <div class="card pro-box border h-100 rounded-0 position-relative p-0">
                                ...
                                <div class="card-body product-details-wrap p-2">
                                    <div class="icon-cart-hart <?php echo e(session()->get('direction') == 2 ? 'rtl' : ''); ?>">
        ...
        <div class="container">
            <div class="row g-3">
                ...
                <div class="col-lg-6">
                    ...
                    <h3 class="line-2 main-tital color-changer fw-600"><?php echo e(helper::appdata($storeinfo->id)->whoweare_subtitle); ?></h3>
                        ...
                        <div class="z-index-9 row g-2">
                            <?php $__currentLoopData = @helper::getcategory($storeinfo->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="btn-copy">
                                        <a class="btn rounded-2 copy-btn" id="clickCopy<?php echo e($key); ?>"
                                            onclick="copy('<?php echo e($key); ?>')" data-toggle="tooltip"
                                            data-placement="top" title="Copy">
                                            <i class="fa-solid fa-copy"></i>
                                        </a>
                                    </div>
                                    <div id="goodContent<?php echo e($key); ?>" class="d-none">
                                        <?php echo e(URL::to($storeinfo->slug . '/search?category=' . $category->slug)); ?>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <?php if($item->stock_management == 1): ?>
                                            ...
                                            <?php else: ?>
                                                <div class="in-stock">
                                                    <span class="in-stock-indicator-dot"></span>
                                                    <p class="in-stock-text m-0"><?php echo e(trans('labels.in_stock')); ?>
    ...
    <section class="blog-6-sec my-5">
        <div class="container">
            ...
            <div class="sec-header mb-4">
                ...
                <p class="m-0 line-2 fs-15 fw-500 mt-2 text-muted"><?php echo e(trans('labels.our_latest_blogs_subtitle')); ?></p>
            </div>
            <!-- blogs -->
                                ...
                                <div class="item mx-1 h-100">
                                    <div class="card border h-100 overflow-hidden">
                                        <div class="blog-6-img">
                                            <a href="<?php echo e(URL::to($storeinfo->slug . '/blogs-' . $blog[$i]->slug)); ?>">
                                                <img src="<?php echo e(helper::image_path($blog[$i]->image)); ?>" height="300"
                                        ...
                                        <div class="card-body">
                                            <h4 class="title line-2">
                                                <a class="color-changer text-dark"
                                                    href="<?php echo e(URL::to($storeinfo->slug . '/blogs-' . $blog[$i]->slug)); ?>"><?php echo e($blog[$i]->title); ?></a>
                                            </h4>
                                            <span class="blog-created text-muted">
                                                <i class="fa-regular fa-calendar-days"></i>
                                                <span
                                                    class="date"><?php echo e(helper::date_format($blog[$i]->created_at, $storeinfo->id)); ?></span>
                                            </span>
                                            <div class="description color-changer line-2"><?php echo Str::limit($blog[$i]->description, 200); ?></div>
                                        </div>
                                    </div>
                                </div>
                            <?php endfor; ?>
...
<?php /**PATH /home/u459716940/domains/matjarhub.com/public_html/resources/views/front/template-10/home.blade.php ENDPATH**/ ?>