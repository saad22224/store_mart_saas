...
<?php $__env->startSection('content'); ?>
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex">
            ...
            <button type="button" class="btn btn-secondary px-sm-4 d-flex mx-2 <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_products', Auth::user()->role_id, $vendor_id, 'add') == 1 ? '' : 'd-none') : ''); ?>" style="background: linear-gradient(135deg, #e1306c, #c13584); border: none; color: white;" data-bs-toggle="modal" data-bs-target="#instagramImportModal">
                <i class="fa-brands fa-instagram mx-1" style="margin-top: 2px;"></i> <?php echo e(trans('labels.import_from_instagram')); ?>
    ...
    <select id="prodCategoryTemplate" style="display:none;">
        ...
        <?php $__currentLoopData = $getcategorylist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Storemart_SaaS\resources\views/admin/product/product.blade.php ENDPATH**/ ?>