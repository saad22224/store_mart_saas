                ...
                <div class="col-md-12 my-2 d-flex justify-content-end">
                    <?php if($getorderdata->status_type == '1'): ?>
                        <span class="px-sm-4 btn btn-warning">
                            <?php echo e($translateStatus(@helper::gettype($getorderdata->status, $getorderdata->status_type, $getorderdata->order_type, $vendor_id)->name == null ? '-' : @helper::gettype($getorderdata->status, $getorderdata->status_type, $getorderdata->order_type, $vendor_id)->name)); ?>
                    ...
                    <?php if($getorderdata->status_type != 3 || $getorderdata->status_type != 4): ?>
                        <div class="lag-btn dropdown">
                            <button type="button" class="btn btn-sm btn-secondary dropdown-toggle py-2 px-sm-4"
                                data-bs-toggle="dropdown"><?php echo e($translateStatus(@helper::gettype($getorderdata->status, $getorderdata->status_type, $getorderdata->order_type, $vendor_id)->name == null ? '-' : @helper::gettype($getorderdata->status, $getorderdata->status_type, $getorderdata->order_type, $vendor_id)->name)); ?></button>
                            <div
                                ...
                                <?php $__currentLoopData = helper::customstauts($getorderdata->vendor_id, $getorderdata->order_type); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a class="dropdown-item w-auto cursor-pointer p-2 <?php if($getorderdata->status == $status->id): ?> fw-600 <?php endif; ?>"
                                        onclick="statusupdate('<?php echo e(URL::to('admin/orders/update-' . $getorderdata->id . '-' . $status->id . '-' . $status->type)); ?>')"><?php echo e($translateStatus($status->name)); ?></a>
                                    ...
                                    <tr class="align-middle fs-7 fw-500">
                                        <td><?php echo e($orders->item_name); ?>
                                            ...
                                            <?php else: ?>
                                                ...
                                                ?>
                                            <?php endif; ?>
                                            <?php if($orders->color_choice != null): ?>
                                                <br><small><b class="text-muted"><?php echo e(trans('labels.colors') ?? 'Colors'); ?></b>: <?php echo e($orders->color_choice); ?></small>
                                            <?php endif; ?>
                                        </td>
                                        <td class="<?php echo e(session()->get('direction') == '2' ? 'text-start' : 'text-end'); ?>">
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Storemart_SaaS\resources\views/admin/orders/invoice.blade.php ENDPATH**/ ?>