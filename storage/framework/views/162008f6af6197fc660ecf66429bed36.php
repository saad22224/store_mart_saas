...
<head>
    ...
    <style>
        :root {
            --bs-primary: <?php echo e(helper::appdata(@$vendor_id)->primary_color); ?>;
            --bs-secondary: <?php echo e(helper::appdata(@$vendor_id)->secondary_color); ?>;
        }
    </style>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ServerDemo_StoreMart/Storemart_v.4.4/Storemart/resources/views/admin/layout/pos_header.blade.php ENDPATH**/ ?>