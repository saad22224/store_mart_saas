                        ...
                        <form action="<?php echo e(URL::to('admin/products/update-' . $getproductdata->slug)); ?>" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectpicker" name="product_classifications[]" multiple data-live-search="true" title="<?php echo e(trans('labels.select')); ?>">
                                            <option value="top_deals" <?php echo e($getproductdata->top_deals == 1 ? 'selected' : ''); ?>><?php echo e(trans('labels.featured_product')); ?></option>
                                            <option value="is_new_arrival" <?php echo e($getproductdata->is_new_arrival == 1 ? 'selected' : ''); ?>><?php echo e(trans('labels.new_arrival')); ?></option>
                                            <option value="is_best_selling" <?php echo e($getproductdata->is_best_selling == 1 ? 'selected' : ''); ?>><?php echo e(trans('labels.best_seller')); ?></option>
                                            <option value="is_exclusive" <?php echo e($getproductdata->is_exclusive == 1 ? 'selected' : ''); ?>><?php echo e(trans('labels.exclusive_offer')); ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="colors" id="colors" placeholder="<?php echo e(trans('labels.colors_placeholder', ['default' => 'e.g. Red, Blue, Green'])); ?>" value="<?php echo e($getproductdata->colors); ?>">
                                ...
                                <div
                                    ...
                                    <div class="form-group">
                                        <label for="has_extras"
                                            class="col-form-label"><?php echo e(trans('labels.product_has_addons')); ?></label>
                                        <div class="col-md-12">
                                ...
                                <input type="hidden" name="has_variants" id="has_variants_hidden"
                                    value="<?php echo e($getproductdata->has_variants); ?>">
                                <?php endif; ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        $(document).on('click', '.get-variants-size', function(e) {
            $("#commonModal .modal-title").html('<?php echo e(trans('labels.add_size')); ?>');
            $("#commonModal .modal-dialog").addClass('modal-md');
            $("#commonModal").modal('show');
            var data_url = $(this).attr('dataa-url');
