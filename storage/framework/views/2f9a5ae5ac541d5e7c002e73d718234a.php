    ...
    <div class="t16-tabs-bar">
        ...
        <div class="t16-cat-reveal-wrap">
            <button class="t16-cat-reveal" type="button" onclick="t16ScrollCategories()" aria-label="Scroll categories">
                <i class="fa-solid <?php echo e(session()->get('direction') == 2 ? 'fa-arrow-left-long' : 'fa-arrow-right-long'); ?>"></i>
            </button>
        </div>
...
<?php /**PATH C:\laragon\www\Storemart_SaaS\resources\views/front/template-16/home.blade.php ENDPATH**/ ?>