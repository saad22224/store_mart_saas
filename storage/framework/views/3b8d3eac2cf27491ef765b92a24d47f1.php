        ...
        <div class="container">
            <div class="text-center order-success-img">
                ...
                <h4 class="mb-5 order-title color-changer <?php echo e(session()->get('direction') == '2' ? 'text-right' : ''); ?>">
                    <?php echo e(trans('labels.order_successfull')); ?></h4>
                <div class="d-md-flex mb-4 col-md-8 col-12 mx-auto">
                    ...
                    <button onclick="copytext('<?php echo e(trans('labels.copied')); ?>')" class="btn btn-store mx-sm-2 btn-100">
                        <span class="tooltiptext" id="tool"><?php echo e(trans('labels.copy')); ?></span>
                    </button>
                </div>
                <div class="d-md-flex justify-content-center align-content-center">
                    <a href="<?php echo e(URL::to($host == env('WEBSITE_HOST') ? $storeinfo->slug : '')); ?>"
...
<?php /**PATH /home/u459716940/domains/matjarhub.com/public_html/resources/views/front/ordersuccess.blade.php ENDPATH**/ ?>