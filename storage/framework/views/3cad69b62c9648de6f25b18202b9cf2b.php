    ...
    <section class="hero-section">
        ...
        <div class="hero-inner">
            ...
            <div class="hero-actions" data-aos="fade-up" data-aos-duration="700" data-aos-delay="300">
                <button class="btn-hero-primary"><?php echo e(@$translations['hero']['btn_primary'] ?? 'ابدأ مجاناً الآن'); ?></button>
                <button class="btn-hero-secondary"><?php echo e(@$translations['hero']['btn_secondary'] ?? 'شاهد العرض التجريبي'); ?></button>
            </div>
        </div>
    </section>
