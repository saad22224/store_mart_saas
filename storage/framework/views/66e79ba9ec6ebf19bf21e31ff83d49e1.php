<div class="row mb-5">
    <div class="col-12">
        <div class="card border-0 box-shadow">
            <form action="<?php echo e(URL::to('/admin/google_login')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card-header rounded-top p-3 bg-secondary">
                    <div class="d-flex align-items-center justify-content-between">
                        <h5 class="text-capitalize fw-600 settings-color"><?php echo e(trans('labels.google_login')); ?></h5>
                        <div class="form-group m-0">
                            <input id="google-switch" type="checkbox" class="checkbox-switch" name="google_mode"
                                value="1" <?php echo e($settingdata->google_mode == 1 ? 'checked' : ''); ?>>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label class="form-label"><?php echo e(trans('labels.google_client_id')); ?><span class="text-danger"> *
                                </span></label>
...
<?php /**PATH /home/u459716940/domains/matjarhub.com/public_html/resources/views/admin/sociallogin/google_login.blade.php ENDPATH**/ ?>