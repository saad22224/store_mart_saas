    ...
    <div class="ob-dots">
        ...
        <div class="text-center">
            ...
            <div class="ob-lbl <?php echo e($s==1?'on':''); ?>" id="l<?php echo e($s); ?>">
                <?php if($s==1): ?> الأقسام <?php elseif($s==2): ?> منتج <?php elseif($s==3): ?> إعدادات <?php else: ?> انطلق <?php endif; ?>
            </div>
        </div>
        <?php if($s<4): ?><div class="ob-line" id="ln<?php echo e($s); ?>"><div class="f"></div></div><?php endif; ?>
        <?php endfor; ?>
    </div>
    ...
    <div class="ob-card">
        ...
        <div class="ob-p on" id="p1">
            ...
            <div class="cat-grid" id="catGrid">
                ...
                <div class="cat-chip" onclick="toggleCat(this)" data-name="<?php echo e($c['name']); ?>" data-img="<?php echo e($c['img']); ?>">
        ...
        <div class="ob-p" id="p3">
            ...
            <div class="row">
                <div class="col-md-6 set-row">
                    ...
                    <input type="email" id="setEmail" value="<?php echo e(@$settings->email); ?>" placeholder="store@example.com">
                </div>
                <div class="col-md-6 set-row">
                    <label>رقم الهاتف *</label>
                    <input type="text" id="setMobile" value="<?php echo e(@$settings->mobile); ?>" placeholder="0123456789">
                </div>
                <div class="col-md-6 set-row">
                    <label>رقم الواتساب</label>
                    <input type="text" id="setWhatsapp" value="<?php echo e(@Auth::user()->whatsapp); ?>" placeholder="0123456789">
                </div>
                <div class="col-md-6 set-row">
                    <label>العنوان *</label>
                    <input type="text" id="setAddress" value="<?php echo e(@$settings->address); ?>" placeholder="المدينة، الشارع">
                </div>
