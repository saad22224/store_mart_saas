...
<style>
    :root {
        --t7-accent: #4a148c;
        --t7-accent-soft: rgba(74, 20, 140, 0.05);
        --t7-card-shadow: 0 10px 30px rgba(0,0,0,0.08);
        --t7-radius: 20px;
    }
    ...
    .t7-breadcrumb-wrap h1 {
        font-weight: 800;
        color: #222;
        margin-bottom: 15px;
        font-size: 32px;
    }
    .t7-breadcrumb-wrap .breadcrumb {
        display: inline-flex;
        background: #f8f9fa;
        padding: 8px 25px;
        border-radius: 50px;
    }
    .t7-breadcrumb-wrap .breadcrumb a {
        color: #666;
        text-decoration: none;
        transition: 0.3s;
        font-weight: 600;
    }
    .t7-breadcrumb-wrap .breadcrumb a:hover {
        color: var(--t7-accent);
    }
    .t7-breadcrumb-wrap .breadcrumb-item.active {
        color: var(--t7-accent);
        font-weight: 700;
    }
    /* .t7-breadcrumb-wrap .breadcrumb-item + .breadcrumb-item::before {
        content: "/";
        color: #ccc;
    } */
    ...
    .t7-search-box-card {
        ...
        box-shadow: 0 15px 40px rgba(74, 20, 140, 0.1) !important;
        margin-top: -45px;
        z-index: 10;
        background: #fff;
        overflow: hidden;
    ...
    .t7-filter-form select, .t7-filter-form input {
    ...
    .t7-filter-form select:focus, .t7-filter-form input:focus {
        border-color: var(--t7-accent) !important;
        box-shadow: 0 0 0 4px var(--t7-accent-soft) !important;
    }
    .t7-search-btn {
        background: var(--t7-accent) !important;
        color: #fff !important;
        border: none !important;
        border-radius: 15px !important;
        height: 60px;
    ...
    .t7-product-card:hover {
        ...
        border-color: var(--t7-accent-soft);
    }
    .t7-pro-img-wrap {
        position: relative;
        aspect-ratio: 1/1;
    ...
    .t7-product-card:hover .t7-pro-img-wrap img {
        transform: scale(1.1);
    }
...
<?php if(helper::appdata($storeinfo->id)->template == 7): ?>
    <div class="t7-breadcrumb-wrap">
        <div class="container">
            <h1><?php echo e(trans('labels.search')); ?></h1>
            <nav aria-label="breadcrumb">
                <div class="d-flex justify-content-center align-items-center gap-2 m-0" style="background: #f8f9fa; padding: 8px 25px; border-radius: 50px; display: inline-flex !important;">
                    <?php if(session()->get('direction') == 2): ?>
                        <a href="<?php echo e(URL::to($storeinfo->slug . '/')); ?>" style="color: #666; text-decoration: none; font-weight: 600;"><?php echo e(trans('labels.home')); ?></a>
                        <span class="text-muted" style="margin: 0 5px;">/</span>
                        <span class="fw-bold" style="color: var(--t7-accent);"><?php echo e(trans('labels.search')); ?></span>
                    <?php else: ?>
                        <a href="<?php echo e(URL::to($storeinfo->slug . '/')); ?>" style="color: #666; text-decoration: none; font-weight: 600;"><?php echo e(trans('labels.home')); ?></a>
                        <span class="text-muted" style="margin: 0 5px;">/</span>
                        <span class="fw-bold" style="color: var(--t7-accent);"><?php echo e(trans('labels.search')); ?></span>
...
<section class="productsearch <?php echo e(helper::appdata($storeinfo->id)->template == 7 ? 't7-search-page' : ''); ?>">
    <div class="container">
        <!-- product search -->
<?php if(helper::appdata($storeinfo->id)->template == 7): ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-10 mx-auto z-index-9">
                <div class="card t7-search-box-card">
                    <form action="<?php echo e(URL::to($storeinfo->slug . '/search')); ?>" method="GET" class="t7-filter-form">
                        <select class="form-select" name="category" onchange="location = $('option:selected',this).data('value');">
                            <option selected value="" data-value="<?php echo e(URL::to($storeinfo->slug . '/search?category=' . '&search_input=' . request()->get('search_input') . '&filter=' . request()->get('filter'))); ?>">
                                <?php echo e(trans('labels.all_category')); ?>

                            </option>
                            <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($item->slug); ?>" <?php echo e($item->slug == request()->get('category') ? 'selected' : ''); ?> data-value="<?php echo e(URL::to($storeinfo->slug . '/search?category=' . $item->slug . '&search_input=' . request()->get('search_input') . '&filter=' . request()->get('filter'))); ?>">
                                    <?php echo e($item->name); ?>

                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <input type="text" class="form-control" name="search_input" value="<?php echo e(request()->get('search_input')); ?>" placeholder="<?php echo e(trans('labels.search_here')); ?>">
                        <button type="submit" class="btn t7-search-btn"><?php echo e(trans('labels.search')); ?></button>
                    </form>
                </div>
            </div>
        </div>
...
<?php endif; ?>
        <?php if(helper::appdata($storeinfo->id)->template == 7): ?>
            <div class="t7-results-meta">
                <span class="fw-bold" style="color: #666;">
                    <?php echo e(trans('labels.showing')); ?> 
                    <span style="color: var(--t7-accent);"><?php echo e($itemlist->firstItem() ?? 0); ?>–<?php echo e($itemlist->lastItem() ?? 0); ?></span>
                    <?php echo e(trans('labels.of')); ?> 
                    <span style="color: var(--t7-accent);"><?php echo e($itemlist->total()); ?></span> <?php echo e(trans('labels.result')); ?>

                </span>
                
                <div class="dropdown">
                    <button class="btn t7-filter-dropdown-btn dropdown-toggle" type="button" data-bs-toggle="dropdown">
                        <i class="fa-solid fa-filter me-2"></i> <?php echo e(trans('labels.filter')); ?>

                    </button>
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0" style="border-radius: 12px; overflow: hidden;">
                        <li><a class="dropdown-item py-2" href="<?php echo e(URL::to($storeinfo->slug . '/search?category=' . @$_GET['category'] . '&search_input=' . @$_GET['search_input'] . '&filter=price-high-to-low')); ?>"><?php echo e(trans('labels.p_high_to_low')); ?></a></li>
                        <li><a class="dropdown-item py-2" href="<?php echo e(URL::to($storeinfo->slug . '/search?category=' . @$_GET['category'] . '&search_input=' . @$_GET['search_input'] . '&filter=price-low-to-high')); ?>"><?php echo e(trans('labels.p_low_to_high')); ?></a></li>
                        <?php if(@helper::checkaddons('product_reviews')): ?>
                            <li><a class="dropdown-item py-2" href="<?php echo e(URL::to($storeinfo->slug . '/search?category=' . @$_GET['category'] . '&search_input=' . @$_GET['search_input'] . '&filter=ratting-high-to-low')); ?>"><?php echo e(trans('labels.r_high_to_low')); ?></a></li>
                            <li><a class="dropdown-item py-2" href="<?php echo e(URL::to($storeinfo->slug . '/search?category=' . @$_GET['category'] . '&search_input=' . @$_GET['search_input'] . '&filter=ratting-low-to-high')); ?>"><?php echo e(trans('labels.r_low_to_high')); ?></a></li>
                        <?php endif; ?>
                    </ul>
                </div>
            </div>
            ...
            <div class="product-prev-sec searchresult mb-5 p-0">
                <div class="listing-view">
                    ...
                    <?php elseif(helper::appdata($storeinfo->id)->template == 7): ?>
                        <div class="row g-4 row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-2">
                            <?php $__currentLoopData = $itemlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    if ($item->top_deals == 1 && helper::top_deals($storeinfo->id) != null) {
                                        if (@helper::top_deals($storeinfo->id)->offer_type == 1) {
                                            ...
                                            if ($item['variation']->count() > 0) {
                                                $price = $item['variation'][0]->price - $item['variation'][0]->price * (@helper::top_deals($storeinfo->id)->offer_amount / 100);
                                            } else {
                                                $price = $item->item_price - $item->item_price * (@helper::top_deals($storeinfo->id)->offer_amount / 100);
                                            }
                                        }
                                        if ($item['variation']->count() > 0) {
                                            $original_price = $item['variation'][0]->price;
                                ...
                                ?>
                                <div class="col">
                                    <div class="t7-product-card">
                                        <div class="t7-pro-img-wrap">
                                            <a href="<?php echo e(URL::to($storeinfo->slug . '/detail-' . $item->slug)); ?>">
                                                <?php if(@$item['product_image']->image == null): ?>
                                                    <img src="<?php echo e(url(env('ASSETPATHURL') . 'admin-assets/images/about/defaultimages/item-placeholder.png')); ?>" alt="product image">
                                                <?php else: ?>
                                                    <img src="<?php echo e(@helper::image_path($item['product_image']->image)); ?>" alt="product image">
                                                <?php endif; ?>
                                            </a>
                                            <?php if($off > 0): ?>
                                                <div class="t7-pro-badge"><?php echo e($off); ?>% <?php echo e(trans('labels.off')); ?></div>
                                            <?php endif; ?>
                                        </div>
                                        <div class="t7-pro-content">
                                            <?php if(@helper::checkaddons('product_reviews') && helper::appdata($storeinfo->id)->product_ratting_switch == 1): ?>
                                                <div class="mb-2" style="font-size: 12px; color: #ffc107;">
                                                    <i class="fa-solid fa-star"></i>
                                                    <span class="text-muted">(<?php echo e(number_format($item->ratings_average, 1)); ?>)</span>
                                                </div>
                                            <?php endif; ?>
                                            <a href="<?php echo e(URL::to($storeinfo->slug . '/detail-' . $item->slug)); ?>">
                                                <h4 class="t7-pro-title"><?php echo e($item->item_name); ?></h4>
                                            </a>
                                            <div class="t7-pro-price-row">
                                                <span class="t7-current-price"><?php echo e(helper::currency_formate($price, $storeinfo->id, $item->currency)); ?></span>
                                                <?php if($original_price > $price): ?>
                                                    <span class="t7-old-price"><?php echo e(helper::currency_formate($original_price, $storeinfo->id, $item->currency)); ?></span>
                                                <?php endif; ?>
                                            </div>

                                            <div class="t7-pro-actions">
                                                <button class="t7-add-btn" id="verifybtn<?php echo e($key); ?>_<?php echo e($item->id); ?>" onclick="GetProductOverview('<?php echo e($item->slug); ?>',this.id)">
                                                    <?php echo e(helper::appdata($storeinfo->id)->online_order == 1 ? trans('labels.add_to_cart') : trans('labels.view')); ?>

                                                </button>
                                                
                                                <?php if(@helper::checkaddons('customer_login') && helper::appdata($storeinfo->id)->checkout_login_required == 1): ?>
                                                    <button class="t7-wish-btn" onclick="managefavorite('<?php echo e($item->id); ?>',<?php echo e($storeinfo->id); ?>,'<?php echo e(URL::to(@$storeinfo->slug . '/managefavorite')); ?>')">
                                                        <?php
                                                            $favorite = false;
                                                        ...
                                                        ?>
                                                        <i class="<?php echo e($favorite ? 'fa-solid fa-heart active' : 'fa-regular fa-heart'); ?>"></i>
                                                    </button>
                                                <?php endif; ?>
                                            </div>
                                        </div>
...
<?php /**PATH C:\laragon\www\Storemart_SaaS\resources\views/front/search.blade.php ENDPATH**/ ?>