...
<head>
    ...
    <?php if(helper::appdata($admin_id)->pwa == 1): ?>
        ...
        <link rel="manifest"
            href='data:application/manifest+json,{"name": "<?php echo e(helper::appdata($admin_id)->app_name); ?>","short_name": "<?php echo e(helper::appdata($admin_id)->app_name); ?>","icons": [{"src": "<?php echo e(helper::image_path(helper::appdata($admin_id)->app_logo)); ?>", "sizes": "512x512", "type": "image/png"}, {"src": "<?php echo e(helper::image_path(helper::appdata($admin_id)->app_logo)); ?>", "sizes": "1024x1024", "type": "image/png"}], "start_url": "<?php echo e(request()->url()); ?>","display": "standalone","prefer_related_applications":"false" }'>
    <?php endif; ?>
    ...
    <div id="installBtn"
        ...
        <div class="flex items-center gap-2 md:gap-3 overflow-hidden">
            <div class="flex-shrink-0">
                <img src="<?php echo e(helper::image_path(helper::appdata(1)->app_logo)); ?>"
            ...
            <div class="flex-1 min-w-0">
                <h4 class="text-[13px] md:text-sm font-bold text-gray-900 leading-tight truncate"
                    data-i18n="install.title"><?php echo e(helper::appdata(1)->app_name); ?></h4>
        ...
        ">
            <div style="display:flex;flex-direction:column;gap:2rem;align-items:center;">
                <a href="#" onclick="closeMobileMenu()"
                    style="font-size:1.25rem;font-weight:700;color:#0F172A;text-decoration:none;"><?php echo e(@$translations['nav']['home'] ?? 'الرئيسية'); ?></a>
                ...
                <a href="#contact" onclick="closeMobileMenu()"
                    style="font-size:1.25rem;font-weight:700;color:#0F172A;text-decoration:none;"><?php echo e(@$translations['nav']['contact'] ?? 'اتصل بنا'); ?></a>
                ...
                <div
                    ...
                    <div class="lang-switcher-mobile" style="position:relative; width: 100%;">
                        ...
                        <div id="mobileLangMenu"
                            ...
                            width: 100%;
                        ">
                            <a href="?lang=ar" class="lang-option <?php echo e($lang == 'ar' ? 'active' : ''); ?>"
                                style="display: block; padding: 0.75rem 1rem; text-decoration: none; color: #0F172A; font-weight: 600; text-align: center;">🇸🇦
                                العربية</a>
                            <a href="?lang=en" class="lang-option <?php echo e($lang == 'en' ? 'active' : ''); ?>"
                    ...
                    <button onclick="window.location.href = '<?php echo e(url('admin/register')); ?>'" class="btn-primary"
                        style="padding: 0.8rem 1.5rem; font-size: 1.1rem; width: 100%;"><?php echo e(@$translations['nav']['create_account'] ?? 'إنشاء حساب'); ?></button>
                </div>
            </div>
    ...
    <section class="hero-section">
        ...
        <div class="hero-inner">
            ...
            <h1 class="hero-title" data-aos="fade-up" data-aos-duration="700" data-aos-delay="100">
                ...
                <span
                    class="gradient-text"><?php echo e(@$translations['hero']['title_highlight'] ?? 'في ثوانٍ معدودة'); ?></span>
            </h1>
    ...
    <section class="who-section" id="who-we-are">
        ...
        <div class="who-inner">
            ...
            <div class="who-content" data-aos="fade-left" data-aos-duration="700">
                ...
                <h2><?php echo e(@$translations['who_we_are']['title_line1'] ?? 'نحن فريق شغوف بـ'); ?><br /><span
                        class="gradient-text"><?php echo e(@$translations['who_we_are']['title_highlight'] ?? 'تمكين التجارة الرقمية'); ?></span>
                </h2>
                <p>
            ...
            <div class="who-image-wrap" data-aos="fade-right" data-aos-duration="700" data-aos-delay="150">
                <img src="<?php echo e(asset('public/images/about.jpeg')); ?>"
                    alt="<?php echo e($lang == 'ar' ? 'فريق Matjar Hub' : 'Matjar Hub Team'); ?>" />
    ...
    <section class="why-us-section" id="why-us">
        <div class="why-us-inner">
            <div class="section-header" data-aos="fade-up" data-aos-duration="700">
                <h2><?php echo e(@$translations['why_us']['title'] ?? 'لماذا تختار'); ?> <span
                        class="gradient-text"><?php echo e(@$translations['why_us']['title_highlight'] ?? 'Matjar Hub؟'); ?></span>
                </h2>
                <p><?php echo e(@$translations['why_us']['subtitle'] ?? 'نحن نوفر لك كل الأدوات التي تحتاجها للنجاح في عالم التجارة الإلكترونية، مع التركيز على البساطة والقوة في وقت واحد.'); ?>
            ...
            <div class="why-us-grid">
                <div class="why-card" data-aos="fade-up" data-aos-duration="600" data-aos-delay="0">
                    ...
                    <p><?php echo e(@$translations['why_us']['card1_desc'] ?? 'متاجرك تعمل على أحدث التقنيات السحابية لضمان سرعة تحميل لا تضاهى عالمياً.'); ?>
                ...
                <div class="why-card" data-aos="fade-up" data-aos-duration="600" data-aos-delay="100">
                    ...
                    <p><?php echo e(@$translations['why_us']['card2_desc'] ?? 'فريقنا متواجد دائماً لمساعدتك في كل خطوة، عبر الواتساب، الهاتف، أو البريد.'); ?>
                ...
                <div class="why-card" data-aos="fade-up" data-aos-duration="600" data-aos-delay="200">
                    ...
                    <p><?php echo e(@$translations['why_us']['card3_desc'] ?? 'اربط متجرك مع كافة خدمات الشحن والدفع والتسويق بضغطة زر واحدة.'); ?>
    ...
    <section class="about-section" id="about">
        <div class="about-inner">
            <div class="about-content" data-aos="fade-left" data-aos-duration="700">
                ...
                <h2><?php echo e(@$translations['value']['title_line1'] ?? 'نمكّن التجار في'); ?> <br /><span
                        class="gradient-text"><?php echo e(@$translations['value']['title_highlight'] ?? 'العالم العربي'); ?></span>
                    <?php echo e(@$translations['value']['title_line2'] ?? 'للوصول للعالمية'); ?></h2>
                <p>
    ...
    <section class="contact-section" id="contact">
        <div class="contact-inner">
            ...
            <div data-aos="fade-left" data-aos-duration="700">
                <h2 class="contact-info-title"><?php echo e(@$translations['contact']['title_line1'] ?? 'دعنا نساعدك في'); ?>

                    <br /><span
                        class="gradient-text"><?php echo e(@$translations['contact']['title_highlight'] ?? 'تحويل فكرتك إلى واقع'); ?></span>
                </h2>
                <p class="contact-info-desc">
                    <?php echo e(@$translations['contact']['description'] ?? 'فريق الخبراء لدينا جاهز للرد على استفساراتك ومساعدتك في اختيار الخطة الأنسب لمشروعك.'); ?>
                    ...
                    <div class="contact-item">
                        ...
                        <div>
                            <div class="contact-item-label">
                                <?php echo e(@$translations['contact']['phone_label'] ?? 'الهاتف الموحد'); ?></div>
                            <div class="contact-item-value">
                                <?php echo e(@$translations['contact']['phone_value'] ?? '+966 800 123 4567'); ?></div>
                        </div>
                    </div>
                    <div class="contact-item">
                        ...
                        <div>
                            <div class="contact-item-label">
                                <?php echo e(@$translations['contact']['whatsapp_label'] ?? 'واتساب مباشر'); ?></div>
                            <div class="contact-item-value">
                                <?php echo e(@$translations['contact']['whatsapp_value'] ?? '+966 50 123 4567'); ?></div>
                        </div>
                    </div>
                    <div class="contact-item">
                        ...
                        <div>
                            <div class="contact-item-label">
                                <?php echo e(@$translations['contact']['email_label'] ?? 'البريد الإلكتروني'); ?></div>
                            <div class="contact-item-value">
                                <?php echo e(@$translations['contact']['email_value'] ?? 'hello@smartstore.sa'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <form action="<?php echo e(route('landing2.contact')); ?>" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group" style="margin-bottom:0;">
                            ...
                            <input type="text" name="name" required
                                placeholder="<?php echo e(@$translations['contact']['form_name_placeholder'] ?? 'أدخل اسمك'); ?>" />
                        </div>
                        <div class="form-group" style="margin-bottom:0;">
                    ...
                    <div class="form-group">
                        ...
                        <select name="inquiry_type" required>
                            <option value="دعم فني">
                                <?php echo e(@$translations['contact']['form_inquiry_support'] ?? 'دعم فني'); ?></option>
                            <option value="استفسار مبيعات">
                                <?php echo e(@$translations['contact']['form_inquiry_sales'] ?? 'استفسار مبيعات'); ?></option>
                            <option value="شراكات">
                                <?php echo e(@$translations['contact']['form_inquiry_partners'] ?? 'شراكات'); ?></option>
                            <option value="أخرى"><?php echo e(@$translations['contact']['form_inquiry_other'] ?? 'أخرى'); ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="message" rows="4" required
                            placeholder="<?php echo e(@$translations['contact']['form_message_placeholder'] ?? 'كيف يمكننا مساعدتك؟'); ?>"></textarea>
                    </div>

                    <button type="submit"
                        class="btn-submit"><?php echo e(@$translations['contact']['form_submit'] ?? 'إرسال الرسالة'); ?></button>
                </form>
            </div>
        </div>
    </section>
        ...
        <div class="footer-inner">
            <div style="text-align:center;">
                ...
                <div class="footer-brand-desc">
                    <?php echo e(@$translations['footer']['brand_desc'] ?? 'المنصة الرائدة في تمكين التجار في العالم العربي'); ?>
            ...
            <div class="footer-copy">
                <?php echo e(@$translations['footer']['copyright'] ?? '© 2026 Matjar Hub. جميع الحقوق محفوظة.'); ?></div>
        </div>
    </footer>
            ...
            <div class="d-block d-sm-none" id="pwa-container">
                <div class="pwa d-flex gap-2"
                    ...
                    <div class="d-flex align-items-center gap-2" style="display:flex;align-items:center;gap:10px;">
                        <img src="<?php echo e(helper::image_path(helper::appdata($admin_id)->app_logo)); ?>" class="pwa-image"
                            alt="" height="40px" style="border-radius:10px;">
                        <div class="pwa-content">
                            <h5 class="mb-1 line-1 fs-7" style="margin:0;font-size:14px;font-weight:700;">
                                <?php echo e(helper::appdata($admin_id)->app_title); ?></h5>
                            <p class="m-0 fs-8 line-1 text-dark" style="margin:0;font-size:12px;color:#475569;">
                                <?php echo e(trans('labels.pwa_message') ?? 'Add to Home Screen'); ?></p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center gap-2" style="display:flex;align-items:center;gap:10px;">
                        <a class="btn mobile-install-btn" id="mobile-install-app"
                            style="background:#15AC82;color:#fff;padding:5px 10px;border-radius:5px;font-size:12px;cursor:pointer;"><?php echo e(trans('labels.install') ?? 'Install'); ?></a>
...
<?php /**PATH C:\laragon\www\matjarhub\resources\views/landing2/index.blade.php ENDPATH**/ ?>