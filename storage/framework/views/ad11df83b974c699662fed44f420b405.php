            ...
            <?php else: ?>
                <div class="col-lg-5 col-md-6">
                    <div class="vela-feature-card">
                        ...
                        <h4 class="vela-feature-title"><?php echo e(trans('labels.offers_discounts') == 'labels.offers_discounts' ? 'OFFERS & DISCOUNTS' : trans('labels.offers_discounts')); ?></h4>
                        <p class="vela-feature-desc"><?php echo e(trans('labels.offers_desc') == 'labels.offers_desc' ? 'Our store provides high-quality products at competitive prices, with numerous offers and discounts available on all products year-round.' : trans('labels.offers_desc')); ?></p>
                    </div>
                </div>
                <div class="col-lg-5 col-md-6">
                    <div class="vela-feature-card">
                        ...
                        <h4 class="vela-feature-title"><?php echo e(trans('labels.customer_reviews') == 'labels.customer_reviews' ? 'CUSTOMER REVIEWS 4.8/5' : trans('labels.customer_reviews')); ?></h4>
                        <p class="vela-feature-desc"><?php echo e(trans('labels.reviews_desc') == 'labels.reviews_desc' ? 'Customer satisfaction is our primary goal. We believe you will find the products that best meet your needs.' : trans('labels.reviews_desc')); ?></p>
                    </div>
                </div>
            <?php endif; ?>
        </div>
...
<div class="vela-footer-bottom">
    <div class="container">
        <p>Powered By <a href="<?php echo e(env('APP_URL', url('/'))); ?>" style="color: inherit; text-decoration: none; font-weight: 700;">matjarhub</a></p>
    </div>
</div>
...
<?php /**PATH C:\laragon\www\matjarhub\resources\views/front/template-17/layout/footer.blade.php ENDPATH**/ ?>