                    ...
                    <form action="<?php echo e(URL::to('admin/categories/update-' . $editcategory->slug)); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <?php if(!empty($editcategory->image) && $editcategory->image != 'default.png'): ?>
                                    <img src="<?php echo e(helper::image_path($editcategory->image)); ?>" class="img-fluid rounded mt-2" style="height: 50px">
                                <?php endif; ?>
                            </div>
                            <div class="mt-3 <?php echo e(session()->get('direction') == '2' ? 'text-start' : 'text-end'); ?>">
                                ...
                                <button class="btn btn-primary px-sm-4 <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_categories', Auth::user()->role_id, $vendor_id, 'edit') == 1  ? '':'d-none'): ''); ?>" <?php if(env('Environment') == 'sendbox'): ?> type="button"
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Storemart_SaaS\resources\views/admin/category/edit.blade.php ENDPATH**/ ?>