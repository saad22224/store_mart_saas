                ...
                <?php if(@helper::checkaddons('question_answer')): ?>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" href="javascript:void(0)" data-bs-toggle="pill"
                            ...
                            role="tab"><?php echo e(trans('labels.quastions_ans')); ?></a>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
...
<?php /**PATH /home/u459716940/domains/matjarhub.com/public_html/resources/views/front/detail.blade.php ENDPATH**/ ?>