                                        ...
                                        <tr class="align-middle">
                                                    ...
                                                    <div class="details">
                                                        <div class="d-flex justify-content-between mb-2 mb-sm-0">
                                                            <div class="cart_title">
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if($cart->color_choice != null): ?>
                                                                    <li class="mb-2">
                                                                        <p>
                                                                            <span class="text-muted fs-7">
                                                                                <?php echo e(trans('labels.colors') ?? 'Colors'); ?>: <?php echo e($cart->color_choice); ?>
                                            ...
                                            <td>
                                                <p class="cart-total-price m-0 td_a text-left" id="total_price">
                                                    <?php echo e(helper::currency_formate($cart->price, $storeinfo->id, $cart->currency)); ?>
...
<?php /**PATH C:\laragon\www\matjarhub\resources\views/front/cart.blade.php ENDPATH**/ ?>