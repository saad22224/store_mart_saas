        ...
        <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item text-dark">
                    <a href="<?php echo e(URL::to('admin/store_categories')); ?>" class="color-changer"><?php echo e(trans('labels.store_categories')); ?></a>
                </li>
                    ...
                    <form action="<?php echo e(URL::to('admin/store_categories/save')); ?>" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="mt-3 <?php echo e(session()->get('direction') == '2' ? 'text-start' : 'text-end'); ?>">
                                ...
                                <button
                                    class="btn btn-primary px-sm-4 <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_store_categories', Auth::user()->role_id, Auth::user()->vendor_id, 'add') == 1 ? '' : 'd-none') : ''); ?>"
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u459716940/domains/matjarhub.com/public_html/resources/views/admin/store_categories/add.blade.php ENDPATH**/ ?>