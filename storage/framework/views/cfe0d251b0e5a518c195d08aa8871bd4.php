...
<html>
    <head>
        ...
        <link rel="icon" type="image/png" href="<?php echo e(url(env('ASSETPATHURL') . 'installer/img/favicon/favicon-16x16.png')); ?>" sizes="16x16"/>
        <link rel="icon" type="image/png" href="<?php echo e(url(env('ASSETPATHURL') . 'installer/img/favicon/favicon-32x32.png')); ?>" sizes="32x32"/>
        <link rel="icon" type="image/png" href="<?php echo e(url(env('ASSETPATHURL') . 'installer/img/favicon/favicon-96x96.png')); ?>" sizes="96x96"/>
        <link href="<?php echo e(url(env('ASSETPATHURL') . 'installer/css/style.min.css')); ?>" rel="stylesheet"/>
...
<?php /**PATH C:\laragon\www\Storemart_SaaS\resources\views/vendor/installer/layouts/master.blade.php ENDPATH**/ ?>