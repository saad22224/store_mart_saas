                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="recaptcha_version" required
                                        ...
                                        <option value="v2"
                                            <?php echo e(@$settingdata->recaptcha_version == 'v2' ? 'selected' : ''); ?>>V2</option>
                                        <option value="v3"
                                            <?php echo e(@$settingdata->recaptcha_version == 'v3' ? 'selected' : ''); ?>>V3</option>
                                    </select>
...
<?php /**PATH /home/u459716940/domains/matjarhub.com/public_html/resources/views/admin/cookie_recaptcha/setting_form.blade.php ENDPATH**/ ?>