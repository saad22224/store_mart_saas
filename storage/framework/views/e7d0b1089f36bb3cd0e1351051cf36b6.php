...
<body>
    ...
    <main id="main-content">
        ...
        <!-- navbar -->
        <?php if(!in_array(helper::appdata(@$storeinfo->id)->template, [7, 11, 16, 17, 18, 19, 20, 21])): ?>
                        ...
                        <div class="d-flex align-items-center mobile-header">
                            <div class="col-md-6 p-0 ">
                                <div class="header-contact">
                                    <a href="tel:<?php echo e($storePhone); ?>" target="_blank"
                                        class="color-changer"><i class="fa-light fa-phone-flip"></i><span
                                            class="mx-2"><?php echo e($storePhone); ?></span></a>
      
                                    <a href="mailto:<?php echo e($storeEmail); ?>" target="_blank"
                                        class="color-changer"><i class="fa-light fa-envelope"></i><span
                                            class="mx-2"><?php echo e($storeEmail); ?></span></a>
                                </div>
                            </div>
                            <div class="col-md-6 p-0 ">
        ...
        <?php elseif(helper::appdata(@$storeinfo->id)->template == 16): ?>
            <!-- Template 16 – Clean Walashi-style Header -->
            <header class="t16-header sticky-top">
                <div class="t16-header-container">
                    <!-- Left: Logo -->
                    <a href="<?php echo e(URL::to($storeinfo->slug)); ?>" class="t16-header-logo">
                        <img src="<?php echo e(helper::image_path(helper::appdata(@$storeinfo->id)->logo)); ?>" alt="Logo">
                    </a>
                    ...
                    <div class="t16-header-actions">
                        <?php if(@helper::checkaddons('customer_login') && helper::appdata(@$storeinfo->id)->checkout_login_required == 1): ?>
                            <?php if(Auth::user() && Auth::user()->type == 3): ?>
                                <a href="<?php echo e(URL::to($storeinfo->slug . '/profile')); ?>" class="t16-hdr-btn" title="<?php echo e(trans('labels.account')); ?>">
                                    <i class="fa-regular fa-user"></i>
                                </a>
                            <?php else: ?>
                                <a href="javascript:void(0)" data-bs-toggle="offcanvas" data-bs-target="#loginpage" class="t16-hdr-btn" title="<?php echo e(trans('labels.login')); ?>">
                                    <i class="fa-regular fa-user"></i>
                                </a>
                            <?php endif; ?>
                        <?php endif; ?>
                        ...
                        <?php if(helper::appdata(@$storeinfo->id)->online_order == 1): ?>
                            <a href="<?php echo e(URL::to($storeinfo->slug . '/cart/')); ?>" class="t16-hdr-btn t16-cart-btn" title="<?php echo e(trans('labels.cart')); ?>">
                                <i class="fa-regular fa-cart-shopping"></i>
                                <span class="t16-hdr-badge" id="cartcnt"><?php echo e(session()->get('cart') ?? 0); ?></span>
                            </a>
                        <?php endif; ?>
                        ...
                        <div class="dropdown">
                            <a class="t16-hdr-btn t16-lang-btn dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" title="Language">
                                <span class="t16-lang-code"><?php echo e(strtoupper(App::getLocale())); ?></span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end t16-lang-dropdown">
                                <?php if(\App::getLocale() == 'en'): ?>
                                    <li><a class="dropdown-item" href="<?php echo e(URL::to('/lang/change?lang=ar')); ?>"><span>🇸🇦</span> العربية</a></li>
                                <?php else: ?>
                                    <li><a class="dropdown-item" href="<?php echo e(URL::to('/lang/change?lang=en')); ?>"><span>🇺🇸</span> English</a></li>
                                <?php endif; ?>
                            </ul>
                        </div>
                    </div>
            ...
            <style>
                ...
                .t16-hdr-badge {
                    position: absolute;
                    top: -4px;
                    <?php echo e(session()->get('direction') == 2 ? 'left: -4px;' : 'right: -4px;'); ?>
        ...
        <?php elseif(in_array(helper::appdata(@$storeinfo->id)->template, [ 16 , 17, 18, 19, 20, 21])): ?>
            <?php
                $tpl_num = helper::appdata(@$storeinfo->id)->template;
            ?>
            <?php if(view()->exists('front.template-'.$tpl_num.'.layout.header')): ?>
                <?php echo $__env->make('front.template-'.$tpl_num.'.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php else: ?>
        ...
        <!----------------------- mobile menu footer ----------------------->
        <?php if(!in_array(helper::appdata(@$storeinfo->id)->template , [16 , 17 , 18 , 19 , 20 , 21])): ?>
