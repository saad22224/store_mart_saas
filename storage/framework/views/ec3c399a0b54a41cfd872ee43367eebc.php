...
<ul class="navbar-nav">
    ...
    <li class="nav-item mb-2 fs-7">
        <a class="nav-link rounded d-flex align-items-center justify-content-between <?php echo e(request()->is('admin/vendor_themes*') ? 'active' : ''); ?>"
            aria-current="page" href="<?php echo e(URL::to('admin/vendor_themes')); ?>">
    ...
    <?php if(Auth::user()->type == 2 || (Auth::user()->type == 4 && Auth::user()->vendor_id != 1)): ?>
        ...
        <li
            ...
            <ul class="collapse" id="products-menu">
                ...
                <?php if($user->allow_without_subscription == 1 || @$checkplan->tax_report == 1): ?>
                <li
                ...
                <?php endif; ?>
                <?php if($user->allow_without_subscription == 1 || @$checkplan->global_addons == 1): ?>
                <li
                ...
                <?php if(@helper::checkaddons('question_answer') && ($user->allow_without_subscription == 1 || @$checkplan->product_qa == 1)): ?>
                    <li
               ...
               <?php if(@helper::checkaddons('product_import') && ($user->allow_without_subscription == 1 || @$checkplan->bulk_import == 1)): ?>
                    <li
                ...
                <?php endif; ?> 
           <?php if($user->allow_without_subscription == 1 || @$checkplan->shipping_management == 1): ?>
           <li
        ...
        <?php if(@helper::checkaddons('top_deals') && ($user->allow_without_subscription == 1 || @$checkplan->top_deals == 1)): ?>
            <li
    ...
    <?php if(@helper::checkaddons('subscription')): ?>
        ...
        <?php endif; ?>
        <?php if($user->allow_without_subscription != 1 and Auth::user()->type != 2 ): ?>
            <li
    ...
    <?php if(Auth::user()->type == 1 || (Auth::user()->type == 4 && Auth::user()->vendor_id == 1)): ?>
        ...
        <li
            class="nav-item mb-2 fs-7 <?php echo e(helper::check_menu($role_id, 'role_basic_settings') == 1 ? 'd-block' : 'd-none'); ?>">
            <a class="nav-link d-flex rounded <?php echo e(request()->is('admin/landing2*') ? 'active' : ''); ?>"
                aria-current="page" href="<?php echo e(URL::to('/admin/landing2')); ?>">
...
<?php /**PATH C:\laragon\www\matjarhub\resources\views/admin/layout/sidebarcommon.blade.php ENDPATH**/ ?>