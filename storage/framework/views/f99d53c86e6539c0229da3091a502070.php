                        ...
                        <div class="product-variations-wrapper">
                            <div class="size-variation modal_size_variation" id="modal_variation">
                                ...
                                <?php for($i = 0; $i < count($getitem->variants_json); $i++): ?>
                                    <?php if(helper::is_restaurant_store($storeinfo->id)): ?>
                                        <label class="fw-bold form-label mt-3 fs-6" for="">
                                            <i class="fa-solid fa-pizza-slice text-primary me-1"></i>
                                            <?php echo e(trans('labels.select_size') ?? 'Select Size'); ?> (<?php echo e($getitem->variants_json[$i]['variant_name']); ?>)
                                        </label><br>
                                        <div class="d-flex flex-wrap gap-2 border-bottom pb-3 mt-2">
                                            <?php for($t = 0; $t < count($getitem->variants_json[$i]['variant_options']); $t++): ?>
                                                <label
                                                    class="btn btn-outline-primary check<?php echo e(str_replace(' ', '_', $getitem->variants_json[$i]['variant_name'])); ?> <?php echo e($t == 0 ? 'active' : ''); ?>"
                            ...
                            <div class="woo_colors_list text-left w-100">
                                <span id="extras">
                                    <h5 class="extra-title fw-semibold color-changer mb-3">
                                        <?php if(helper::is_restaurant_store($storeinfo->id)): ?>
                                            <i class="fa-solid fa-plus-circle text-primary me-1"></i> <?php echo e(trans('labels.add_extras') ?? 'Add Extras'); ?>
                                                    ...
                                                    <li class="mb-3">
                                                        <label class="d-flex align-items-center justify-content-between p-2 border rounded cursor-pointer shadow-sm">
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <span class="color-changer fw-medium"><?php echo e($extras->name); ?></span>
                                                            </div>
                                                            <span class="text-success fw-bold">+<?php echo e(helper::currency_formate($extras->price, $getitem->vendor_id, $getitem->currency)); ?></span>
                                                        </label>
                                                    </li>
                                                <?php else: ?>
                                                    <li class="mb-2">
