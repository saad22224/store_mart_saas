    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb">
                ...
                <li class="text-muted breadcrumb-item <?php echo e(session()->get('direction') == 2 ? 'rtl' : ''); ?> text-dark active" aria-current="page"><?php echo e(trans('labels.privacypolicy')); ?></li>
...
<section class="product-prev-sec cms-section product-list-sec">
    <div class="container">
        <?php if(@$privacy->privacypolicy_content != ""): ?>
...
<?php echo $__env->make('front.theme.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Storemart_SaaS\resources\views/front/privacy.blade.php ENDPATH**/ ?>