        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="text-muted <?php echo e(session()->get('direction') == 2 ? 'breadcrumb-item-rtl' : ' breadcrumb-item '); ?>"
                    aria-current="page"><?php echo e(trans('landing.privacy_policy')); ?></li>
            </ol>
        </nav>
    </div>
</section>
    ...
    <div class="about-us-bg-color">
        <div class="container">
            <div class="about-us-main">
                <?php if(!empty($privacypolicy->privacypolicy_content)): ?>
                    <div class="cms-section my-3">

                        <?php echo $privacypolicy->privacypolicy_content; ?>
...
<?php echo $__env->make('landing.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u459716940/domains/matjarhub.com/public_html/resources/views/landing/privacypolicy.blade.php ENDPATH**/ ?>